...
public class DigestScheme extends RFC2617Scheme {
    ...
    /* renamed from: NC */
    private static final String f375NC = "00000001";
    ...
    private String createDigest(Credentials credentials) throws AuthenticationException {
        ...
        if (uri == null) {
            ...
            if (this.qopVariant == 0) {
                ...
                StringBuilder sb4 = new StringBuilder(hasha1.length() + nonce.length() + f375NC.length() + cnonce3.length() + qopOption.length() + hasha2.length() + 5);
                sb4.append(hasha1);
                sb4.append(':');
                sb4.append(nonce);
                sb4.append(':');
    ...
    private Header createDigestHeader(Credentials credentials, String digest) {
        ...
        if (this.qopVariant != 0) {
            ...
            params.add(new BasicNameValuePair("nc", f375NC));
