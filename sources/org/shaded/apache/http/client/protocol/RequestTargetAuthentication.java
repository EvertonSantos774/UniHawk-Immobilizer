...
public class RequestTargetAuthentication implements HttpRequestInterceptor {
    ...
    public void process(HttpRequest request, HttpContext context) throws HttpException, IOException {
        ...
        } else if (!request.getRequestLine().getMethod().equalsIgnoreCase(HttpMethods.CONNECT) && !request.containsHeader("Authorization") && (authState = (AuthState) context.getAttribute(ClientContext.TARGET_AUTH_STATE)) != null && (authScheme = authState.getAuthScheme()) != null) {
