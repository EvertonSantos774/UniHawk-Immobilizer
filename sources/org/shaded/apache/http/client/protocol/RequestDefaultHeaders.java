...
public class RequestDefaultHeaders implements HttpRequestInterceptor {
    public void process(HttpRequest request, HttpContext context) throws HttpException, IOException {
        ...
        } else if (!request.getRequestLine().getMethod().equalsIgnoreCase(HttpMethods.CONNECT) && (defHeaders = (Collection) request.getParams().getParameter(ClientPNames.DEFAULT_HEADERS)) != null) {
