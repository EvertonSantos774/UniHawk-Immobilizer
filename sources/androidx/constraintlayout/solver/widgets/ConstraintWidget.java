...
public class ConstraintWidget {
    ...
    /* renamed from: mX */
    protected int f258mX;

    /* renamed from: mY */
    protected int f259mY;
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : "") + (this.mDebugName != null ? "id: " + this.mDebugName + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : "") + "(" + this.f258mX + ", " + this.f259mY + ") - (" + this.mWidth + " x " + this.mHeight + ") wrap: (" + this.mWrapWidth + " x " + this.mWrapHeight + ")";
    }
    ...
    public int getRootX() {
        return this.f258mX + this.mOffsetX;
    }

    /* access modifiers changed from: protected */
    public int getRootY() {
        return this.f259mY + this.mOffsetY;
    }
    ...
    public void updateDrawPosition() {
        int left = this.f258mX;
        int top = this.f259mY;
        int right = this.f258mX + this.mWidth;
        int bottom = this.f259mY + this.mHeight;
        this.mDrawX = left;
        this.mDrawY = top;
    ...
    public void setDrawOrigin(int x, int y) {
        ...
        this.f258mX = this.mDrawX;
        this.f259mY = this.mDrawY;
    }
