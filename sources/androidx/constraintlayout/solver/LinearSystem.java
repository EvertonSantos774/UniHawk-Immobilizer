...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object anchor) {
        ...
        if (variable.f256id != -1 && variable.f256id <= this.mVariablesID && this.mCache.mIndexedVariables[variable.f256id] != null) {
            return variable;
        }
        if (variable.f256id != -1) {
            variable.reset();
        }
        this.mVariablesID++;
        this.mNumColumns++;
        variable.f256id = this.mVariablesID;
