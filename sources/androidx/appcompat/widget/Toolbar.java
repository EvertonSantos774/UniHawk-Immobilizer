...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        titleMargin = a.hasValue(C0002R.styleable.Toolbar_titleMargins) ? a.getDimensionPixelOffset(C0002R.styleable.Toolbar_titleMargins, titleMargin) : titleMargin;
        ...
        if (a.hasValue(C0002R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0002R.styleable.Toolbar_subtitleTextColor, -1));
        }
        a.recycle();
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0002R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0002R.attr.toolbarNavigationButtonStyle);
