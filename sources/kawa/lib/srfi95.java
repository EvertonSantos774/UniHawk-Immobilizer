...
public class srfi95 extends ModuleBody {
    ...
    public static Object isSorted(Object seq, Object less$Qu, Object key) {
        ...
        } else if (C0731lists.isNull(C0731lists.cdr.apply1(seq))) {
            return Boolean.TRUE;
        } else {
            Object last = Scheme.applyToArgs.apply2(key, C0731lists.car.apply1(seq));
            Object apply1 = C0731lists.cdr.apply1(seq);
            while (true) {
                boolean x4 = C0731lists.isNull(apply1);
                if (x4) {
                    return x4 ? Boolean.TRUE : Boolean.FALSE;
                }
                Object nxt2 = Scheme.applyToArgs.apply2(key, C0731lists.car.apply1(apply1));
    ...
    public static Object merge(Object a, Object b, Object isLess, Object key) {
        ...
        frame2.key = key;
        if (C0731lists.isNull(a)) {
            return b;
        }
        if (C0731lists.isNull(b)) {
            return a;
        }
        return frame2.lambda1loop(C0731lists.car.apply1(a), Scheme.applyToArgs.apply2(frame2.key, C0731lists.car.apply1(a)), C0731lists.cdr.apply1(a), C0731lists.car.apply1(b), Scheme.applyToArgs.apply2(frame2.key, C0731lists.car.apply1(b)), C0731lists.cdr.apply1(b));
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda1loop(Object x, Object kx, Object a, Object y, Object ky, Object b) {
            if (Scheme.applyToArgs.apply3(this.less$Qu, ky, kx) != Boolean.FALSE) {
                if (C0731lists.isNull(b)) {
                    return C0731lists.cons(y, C0731lists.cons(x, a));
                }
                return C0731lists.cons(y, lambda1loop(x, kx, a, C0731lists.car.apply1(b), Scheme.applyToArgs.apply2(this.key, C0731lists.car.apply1(b)), C0731lists.cdr.apply1(b)));
            } else if (C0731lists.isNull(a)) {
                return C0731lists.cons(x, C0731lists.cons(y, b));
            } else {
                return C0731lists.cons(x, lambda1loop(C0731lists.car.apply1(a), Scheme.applyToArgs.apply2(this.key, C0731lists.car.apply1(a)), C0731lists.cdr.apply1(a), y, ky, b));
            }
        }
    }
    ...
    public class frame1 extends ModuleBody {
        ...
        public Object lambda3loop(Object r, Object a, Object kcara, Object b, Object kcarb) {
            if (Scheme.applyToArgs.apply3(this.less$Qu, kcarb, kcara) != Boolean.FALSE) {
                try {
                    C0731lists.setCdr$Ex((Pair) r, b);
                    if (C0731lists.isNull(C0731lists.cdr.apply1(b))) {
                        try {
                            C0731lists.setCdr$Ex((Pair) b, a);
                            return Values.empty;
                        } catch (ClassCastException e) {
                            throw new WrongType(e, "set-cdr!", 1, b);
                        }
                    } else {
                        return lambda3loop(b, a, kcara, C0731lists.cdr.apply1(b), Scheme.applyToArgs.apply2(this.key, C0731lists.cadr.apply1(b)));
                    }
                } catch (ClassCastException e2) {
                ...
                try {
                    C0731lists.setCdr$Ex((Pair) r, a);
                    if (C0731lists.isNull(C0731lists.cdr.apply1(a))) {
                        try {
                            C0731lists.setCdr$Ex((Pair) a, b);
                            return Values.empty;
                        } catch (ClassCastException e3) {
                            throw new WrongType(e3, "set-cdr!", 1, a);
                        }
                    } else {
                        return lambda3loop(a, C0731lists.cdr.apply1(a), Scheme.applyToArgs.apply2(this.key, C0731lists.cadr.apply1(a)), b, kcarb);
                    }
                } catch (ClassCastException e4) {
    ...
    static Object sort$ClMerge$Ex(Object a, Object b, Object isLess, Object key) {
        ...
        Object kcara = Scheme.applyToArgs.apply2(frame12.key, C0731lists.car.apply1(a));
        Object kcarb = Scheme.applyToArgs.apply2(frame12.key, C0731lists.car.apply1(b));
        if (Scheme.applyToArgs.apply3(frame12.less$Qu, kcarb, kcara) == Boolean.FALSE) {
            if (C0731lists.isNull(C0731lists.cdr.apply1(a))) {
                ...
                frame12.lambda3loop(a, C0731lists.cdr.apply1(a), Scheme.applyToArgs.apply2(frame12.key, C0731lists.cadr.apply1(a)), b, kcarb);
            }
            return a;
        } else if (C0731lists.isNull(C0731lists.cdr.apply1(b))) {
            try {
                C0731lists.setCdr$Ex((Pair) b, a);
                return b;
            } catch (ClassCastException e2) {
            ...
            frame12.lambda3loop(b, a, kcara, C0731lists.cdr.apply1(b), Scheme.applyToArgs.apply2(frame12.key, C0731lists.cadr.apply1(b)));
            return b;
        }
    }
    ...
    public static Object $PcSortList(Object seq, Object isLess, Object key) {
        ...
        if (key != Boolean.FALSE) {
            ...
            while (!C0731lists.isNull(lst)) {
                try {
                    C0731lists.setCar$Ex((Pair) lst, C0731lists.cons(Scheme.applyToArgs.apply2(key, C0731lists.car.apply1(lst)), C0731lists.car.apply1(lst)));
                    lst = C0731lists.cdr.apply1(lst);
                } catch (ClassCastException e) {
            ...
            try {
                frame02.seq = frame02.lambda2step(Integer.valueOf(C0731lists.length((LList) obj2)));
                Object lst2 = frame02.seq;
                while (!C0731lists.isNull(lst2)) {
                    try {
                        C0731lists.setCar$Ex((Pair) lst2, C0731lists.cdar.apply1(lst2));
                        lst2 = C0731lists.cdr.apply1(lst2);
                    } catch (ClassCastException e2) {
            ...
            try {
                return frame02.lambda2step(Integer.valueOf(C0731lists.length((LList) obj3)));
            } catch (ClassCastException e4) {
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda2step(Object n) {
            if (Scheme.numGrt.apply2(n, srfi95.Lit1) != Boolean.FALSE) {
                ...
                Object x = C0731lists.car.apply1(this.seq);
                Object y = C0731lists.cadr.apply1(this.seq);
                Object p = this.seq;
                this.seq = C0731lists.cddr.apply1(this.seq);
                if (Scheme.applyToArgs.apply3(this.less$Qu, Scheme.applyToArgs.apply2(this.keyer, y), Scheme.applyToArgs.apply2(this.keyer, x)) != Boolean.FALSE) {
                    try {
                        C0731lists.setCar$Ex((Pair) p, y);
                        Object apply1 = C0731lists.cdr.apply1(p);
                        try {
                            C0731lists.setCar$Ex((Pair) apply1, x);
                        } catch (ClassCastException e) {
                ...
                Object apply12 = C0731lists.cdr.apply1(p);
                try {
                    C0731lists.setCdr$Ex((Pair) apply12, LList.Empty);
                    return p;
                } catch (ClassCastException e3) {
                ...
                Object p2 = this.seq;
                this.seq = C0731lists.cdr.apply1(this.seq);
                try {
                    C0731lists.setCdr$Ex((Pair) p2, LList.Empty);
                    return p2;
                } catch (ClassCastException e4) {
    ...
    public static Object sort$Ex(Sequence seq, Object less$Qu, Object key) {
        ...
        Object crt = ret;
        while (C0731lists.cdr.apply1(crt) != seq) {
            crt = C0731lists.cdr.apply1(crt);
        }
        try {
            C0731lists.setCdr$Ex((Pair) crt, ret);
            Object scar = C0731lists.car.apply1(seq);
            Object scdr = C0731lists.cdr.apply1(seq);
            try {
                C0731lists.setCar$Ex((Pair) seq, C0731lists.car.apply1(ret));
                try {
                    C0731lists.setCdr$Ex((Pair) seq, C0731lists.cdr.apply1(ret));
                    try {
                        C0731lists.setCar$Ex((Pair) ret, scar);
                        try {
                            C0731lists.setCdr$Ex((Pair) ret, scdr);
                            return seq;
                        } catch (ClassCastException e) {
    ...
    public static java.lang.Object $PcVectorSort$Ex(gnu.lists.Sequence r5, java.lang.Object r6, java.lang.Object r7) {
        ...
        L_0x000a:
            boolean r2 = kawa.lib.C0731lists.isNull(r1)
    ...
    public static void $PcSortVector(gnu.lists.Sequence r10, java.lang.Object r11, java.lang.Object r12) {
        ...
        L_0x0012:
            boolean r5 = kawa.lib.C0731lists.isNull(r4)
            ...
            gnu.expr.GenericProc r7 = kawa.lib.C0731lists.car
            java.lang.Object r7 = r7.apply1(r4)
            kawa.lib.vectors.vectorSet$Ex(r3, r5, r7)
            gnu.expr.GenericProc r5 = kawa.lib.C0731lists.cdr
