...
public class system extends ModuleBody {
    ...
    public static final ModuleMethod f456catch;
    ...
    static {
        ...
        f456catch = new ModuleMethod(system2, 9, Lit10, 12291);
    ...
    public static Process makeProcess(Object args, Object env) {
        ...
        } else if (C0731lists.isList(args)) {
    ...
    public static Object convertListToStringArray(Object lst) {
        try {
            String[] arr = new String[C0731lists.length((LList) lst)];
            int i = 0;
            Object p = lst;
            while (!C0731lists.isNull(p)) {
                try {
                    Pair pp = (Pair) p;
    ...
    public static Object tokenizeStringToStringArray(String string) {
        ...
        while (toks.hasMoreTokens()) {
            lList = C0731lists.cons(toks.nextToken(), lList);
        }
        try {
            int count = C0731lists.length(lList);
            String[] arr = new String[count];
            int i = count - 1;
            Object p = lList;
            while (!C0731lists.isNull(p)) {
    ...
    /* renamed from: catch  reason: not valid java name */
    public static Object m226catch(Object key, Procedure thunk, Procedure handler) {
        try {
            return thunk.apply0();
    ...
    public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
        ...
        try {
            try {
                return m226catch(obj, (Procedure) obj2, (Procedure) obj3);
            } catch (ClassCastException e) {
