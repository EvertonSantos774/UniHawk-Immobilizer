...
public class misc_syntax extends ModuleBody {
    ...
    static Object lambda1(Object form) {
        ...
        if (Lit1.match(form, allocVars, 0)) {
            ...
            try {
                ...
                return C0731lists.cons(execute, C0731lists.cons(std_syntax.datum$To$SyntaxObject(form, misc.string$To$Symbol(strings.stringAppend(objArr2))), Lit4.execute(allocVars, TemplateScope.make())));
    ...
    static Object lambda3(Object x) {
        ...
        frame2.f251k = execute;
        try {
            frame2.f252p = ports.openInputFile(Path.valueOf(fn));
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda4f() {
            Object x = ports.read(this.f252p);
            if (!ports.isEofObject(x)) {
                return new Pair(std_syntax.datum$To$SyntaxObject(this.f251k, x), lambda4f());
            }
            ports.closeInputPort(this.f252p);
            return LList.Empty;
        }
    }
