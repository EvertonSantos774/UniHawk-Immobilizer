...
public class syntax extends ModuleBody {
    ...
    public static final Macro f454import = Macro.make(Lit36, Lit37, $instance);
    ...
    public static final Macro f455synchronized;
    ...
    static {
        ...
        f455synchronized = Macro.make(Lit25, new ModuleMethod(syntax, 3, (Object) null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), $instance);
    ...
    public static Object importHandleOnly(Object name, Object list) {
        if (C0731lists.memq(name, list) != Boolean.FALSE) {
            return name;
        }
        return null;
    }
    ...
    public static Object importHandleRename(Object name, Object rename$Mnpairs) {
        if (!C0731lists.isPair(rename$Mnpairs)) {
            return name;
        }
        if (name == C0731lists.caar.apply1(rename$Mnpairs)) {
            return C0731lists.cadar.apply1(rename$Mnpairs);
        }
        return importHandleRename(name, C0731lists.cdr.apply1(rename$Mnpairs));
    }
        ...
        public Object lambda1(Object name) {
            ...
            while (true) {
                ...
                if (!x) {
                    ...
                    name = Scheme.applyToArgs.apply3(C0731lists.caar.apply1(l), name, C0731lists.cdar.apply1(l));
                    l = l2;
                } else if (x) {
                    break;
                } else {
                    Object l22 = C0731lists.cdr.apply1(l);
                    name = Scheme.applyToArgs.apply3(C0731lists.caar.apply1(l), name, C0731lists.cdar.apply1(l));
                    l = l22;
                }
            }
    ...
    static Object lambda4(Object form) {
        ...
        if (Lit39.match(form, allocVars, 0)) {
            if (isIdentifierPairList(Lit40.execute(allocVars, TemplateScope.make()))) {
                ...
                return Quote.append$V(new Object[]{Lit41.execute(allocVars, make), Quote.consX$V(new Object[]{C0731lists.cons(C0731lists.cons(import$Mnhandle$Mnrename, Lit42.execute(allocVars, make)), Lit43.execute(allocVars, make)), Lit44.execute(allocVars, make)})});
            }
            ...
            if (isIdentifierList(Lit47.execute(allocVars, TemplateScope.make()))) {
                ...
                return Quote.append$V(new Object[]{Lit48.execute(allocVars, make2), Quote.consX$V(new Object[]{C0731lists.cons(C0731lists.cons(import$Mnhandle$Mnonly, Lit49.execute(allocVars, make2)), Lit50.execute(allocVars, make2)), Lit51.execute(allocVars, make2)})});
            }
            ...
            if (isIdentifierList(Lit54.execute(allocVars, TemplateScope.make()))) {
                ...
                return Quote.append$V(new Object[]{Lit55.execute(allocVars, make3), Quote.consX$V(new Object[]{C0731lists.cons(C0731lists.cons(import$Mnhandle$Mnexcept, Lit56.execute(allocVars, make3)), Lit57.execute(allocVars, make3)), Lit58.execute(allocVars, make3)})});
            }
            ...
            return Quote.append$V(new Object[]{Lit61.execute(allocVars, make4), Quote.consX$V(new Object[]{C0731lists.cons(C0731lists.cons(import$Mnhandle$Mnprefix, Lit62.execute(allocVars, make4)), Lit63.execute(allocVars, make4)), Lit64.execute(allocVars, make4)})});
