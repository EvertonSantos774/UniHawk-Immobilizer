...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public static class DefaultTypeResolverBuilder extends StdTypeResolverBuilder implements Serializable {
        ...
        public boolean useForType(com.shaded.fasterxml.jackson.databind.JavaType r5) {
            /*
                ...
                r1 = 1
                r0 = 0
                int[] r2 = com.shaded.fasterxml.jackson.databind.ObjectMapper.C14572.f371x3ef634e7
    ...
    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping) {
        return enableDefaultTyping(defaultTyping, JsonTypeInfo.C1447As.WRAPPER_ARRAY);
    }

    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping, JsonTypeInfo.C1447As as) {
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.C1448Id.CLASS, (TypeIdResolver) null).inclusion(as));
    }

    public ObjectMapper enableDefaultTypingAsProperty(DefaultTyping defaultTyping, String str) {
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.C1448Id.CLASS, (TypeIdResolver) null).inclusion(JsonTypeInfo.C1447As.PROPERTY).typeProperty(str));
    }
