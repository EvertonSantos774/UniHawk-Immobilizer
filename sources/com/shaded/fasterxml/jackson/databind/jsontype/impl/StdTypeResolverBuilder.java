...
public class StdTypeResolverBuilder implements TypeResolverBuilder<StdTypeResolverBuilder> {
    ...
    protected JsonTypeInfo.C1448Id _idType;
    protected JsonTypeInfo.C1447As _includeAs;
    protected boolean _typeIdVisible = false;
    protected String _typeProperty;

    public static StdTypeResolverBuilder noTypeInfoBuilder() {
        return new StdTypeResolverBuilder().init(JsonTypeInfo.C1448Id.NONE, (TypeIdResolver) null);
    }

    public StdTypeResolverBuilder init(JsonTypeInfo.C1448Id id, TypeIdResolver typeIdResolver) {
        if (id == null) {
    ...
    public TypeSerializer buildTypeSerializer(SerializationConfig serializationConfig, JavaType javaType, Collection<NamedType> collection) {
        if (this._idType == JsonTypeInfo.C1448Id.NONE) {
            return null;
        }
    ...
    public StdTypeResolverBuilder inclusion(JsonTypeInfo.C1447As as) {
        if (as == null) {
