...
public class Base64 {
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void write(int theByte) throws IOException {
            if (this.suspendEncoding) {
                ...
                if (this.position >= this.bufferLength) {
                    this.out.write(Base64.encode3to4(this.f272b4, this.buffer, this.bufferLength, this.options));
                    this.lineLength += 4;
                ...
                if (this.position >= this.bufferLength) {
                    this.out.write(this.f272b4, 0, Base64.decode4to3(this.buffer, 0, this.f272b4, 0, this.options));
                    this.position = 0;
                }
            } else if (this.decodabet[theByte & 127] != -5) {
        ...
        public void flushBase64() throws IOException {
            ...
            if (this.encode) {
                this.out.write(Base64.encode3to4(this.f272b4, this.buffer, this.position, this.options));
                this.position = 0;
                return;
            }
