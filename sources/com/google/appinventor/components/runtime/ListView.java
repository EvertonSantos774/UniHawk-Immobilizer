    ...
    public void setAdapterData() {
        ...
        if (!this.dictItems.isEmpty()) {
            ...
            if (this.orientation == 1) {
                layoutManager = new LinearLayoutManager(this.container.$context(), 0, DEFAULT_ENABLED);
            } else {
                layoutManager = new LinearLayoutManager(this.container.$context(), 1, DEFAULT_ENABLED);
            }
        } else {
