                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status status : C05776.this.replies) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (User user : C05797.this.friends) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (DirectMessage message : C05818.this.messages) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status message : C056712.this.messages) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status tweet : C056913.this.tweets) {
