    ...
    private synchronized void ensureSslSockFactory() {
        if (this.sslSockFactory == null) {
            try {
                ...
                caInput2.close();
                ByteArrayInputStream caInput3 = new ByteArrayInputStream(MIT_CA.getBytes(HTTP.UTF_8));
                Certificate mitca = cf.generateCertificate(caInput3);
                caInput3.close();
                ByteArrayInputStream caInput4 = new ByteArrayInputStream(ISRG_ROOT_X1.getBytes(HTTP.UTF_8));
