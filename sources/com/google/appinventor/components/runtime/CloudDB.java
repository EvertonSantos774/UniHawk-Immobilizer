...
public class CloudDB extends AndroidNonvisibleComponent implements Component, OnClearListener, OnDestroyListener, ObservableDataSource<String, Future<YailList>> {
    ...
    /* renamed from: cm */
    private ConnectivityManager f27cm;
    /* access modifiers changed from: private */
    ...
    public CloudDB(ComponentContainer container) {
        ...
        this.token = "";
        this.redisPort = 6381;
        this.f27cm = (ConnectivityManager) this.form.$context().getSystemService("connectivity");
    }
    ...
    public void StoreValue(String tag, Object valueToStore) {
        ...
        checkProjectIDNotBlank();
        NetworkInfo networkInfo = this.f27cm.getActiveNetworkInfo();
                        ...
                        this.background.submit(new Runnable() {
                            ...
                            public void run() {
                                ...
                                L_0x00dd:
                                    ...
                                    goto L_0x0052
                                */
                                throw new UnsupportedOperationException("Method not decompiled: com.google.appinventor.components.runtime.CloudDB.C03132.run():void");
                            }
                        });
                    }
