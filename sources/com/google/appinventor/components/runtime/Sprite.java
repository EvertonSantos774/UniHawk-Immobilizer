...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, OnDestroyListener, Deleteable {
    ...
    @SimpleProperty
    /* renamed from: Y */
    public void mo7907Y(double y) {
        updateY(y);
        registerChange();
    }

    /* renamed from: Y */
    public double mo5983Y() {
    ...
    @SimpleProperty
    /* renamed from: Z */
    public void mo7909Z(double layer) {
        this.zLayer = layer;
