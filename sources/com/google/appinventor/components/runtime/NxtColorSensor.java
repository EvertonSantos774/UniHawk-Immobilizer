...
public class NxtColorSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    static {
        ...
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_GREEN), NxtSensorType.ColorGreen);
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_BLUE), NxtSensorType.ColorBlue);
