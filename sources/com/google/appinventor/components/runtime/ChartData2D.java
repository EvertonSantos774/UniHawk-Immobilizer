...
public final class ChartData2D extends ChartDataBase {
    ...
    @SimpleFunction
    public void ImportFromSpreadsheet(Spreadsheet sheet, String xColumn, String yColumn, boolean useHeaders) {
        importFromSpreadsheetAsync(sheet, YailList.makeList(Arrays.asList(new String[]{xColumn, yColumn})), useHeaders);
    }
