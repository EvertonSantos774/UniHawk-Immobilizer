    ...
    public String setHmacSeedReturnCode(String seed, String rendezvousServer) {
        ...
        if (this.firstSeed != null) {
            if (!this.firstSeed.equals(seed)) {
                Notifier.oneButtonAlert(this.form, "You cannot use two codes with one start up of the Companion. You should restart the Companion and try again.", HttpHeaders.WARNING, "OK", new Runnable() {
                    public void run() {
