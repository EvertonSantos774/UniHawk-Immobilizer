...
public class AccountChooser {
    ...
    private String createAccount() {
        ...
        try {
            String accountName = this.accountManager.addAccount("com.google", this.service, (String[]) null, (Bundle) null, this.activity, (AccountManagerCallback) null, (Handler) null).getResult().getString("authAccount");
