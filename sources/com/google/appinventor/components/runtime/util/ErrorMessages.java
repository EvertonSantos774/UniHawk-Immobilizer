...
public final class ErrorMessages {
    ...
    static {
        ...
        errorMessages.put(420, "%d is an invalid NXT motor mode.");
        errorMessages.put(Integer.valueOf(ERROR_NXT_INVALID_REGULATION_MODE), "%d is an invalid NXT motor regulation mode.");
        errorMessages.put(422, "%d is an invalid NXT sensor type.");
        errorMessages.put(423, "%d is an invalid NXT sensor mode.");
