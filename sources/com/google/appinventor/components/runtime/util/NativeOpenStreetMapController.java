...
class NativeOpenStreetMapController implements MapFactory.MapController, MapListener {
    ...
    public MapFactory.MapScaleUnits getScaleUnits() {
        switch (C069214.f38xde2f8ad0[this.scaleBar.getUnitsOfMeasure().ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class C069214 {

        /* renamed from: $SwitchMap$org$osmdroid$views$overlay$ScaleBarOverlay$UnitsOfMeasure */
        static final /* synthetic */ int[] f38xde2f8ad0 = new int[ScaleBarOverlay.UnitsOfMeasure.values().length];
        ...
        static {
            ...
            try {
                f38xde2f8ad0[ScaleBarOverlay.UnitsOfMeasure.imperial.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f38xde2f8ad0[ScaleBarOverlay.UnitsOfMeasure.metric.ordinal()] = 2;
            } catch (NoSuchFieldError e4) {
            }
            f37xbe9cb241 = new int[MapFactory.MapScaleUnits.values().length];
            try {
                f37xbe9cb241[MapFactory.MapScaleUnits.METRIC.ordinal()] = 1;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f37xbe9cb241[MapFactory.MapScaleUnits.IMPERIAL.ordinal()] = 2;
