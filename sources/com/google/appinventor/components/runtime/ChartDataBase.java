...
public abstract class ChartDataBase implements Component, DataSourceChangeListener, OnChartGestureListener, OnChartValueSelectedListener {
    ...
    public void Colors(YailList colors2) {
        ...
        for (int i = 0; i < colors2.size(); i++) {
            ...
            try {
                resultColors.add(Integer.valueOf(Integer.parseInt(color2)));
        ...
        this.threadRunner.execute(new Runnable() {
            ...
            public void run() {
                ...
                L_0x002a:
                    ...
                    goto L_0x000b
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.appinventor.components.runtime.ChartDataBase.C029211.run():void");
            }
        });
    }
        ...
        this.threadRunner.execute(new Runnable() {
            ...
            public void run() {
                ...
                L_0x0041:
                    ...
                    goto L_0x000c
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.appinventor.components.runtime.ChartDataBase.C029312.run():void");
            }
        });
    }
        ...
        this.threadRunner.execute(new Runnable() {
            ...
            public void run() {
                ...
                L_0x0040:
                    ...
                    goto L_0x000c
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.appinventor.components.runtime.ChartDataBase.C029413.run():void");
            }
        });
    }
