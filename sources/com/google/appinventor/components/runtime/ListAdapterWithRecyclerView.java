...
public class ListAdapterWithRecyclerView extends RecyclerView.Adapter<RvViewHolder> implements Filterable {
        ...
        public Filter.FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (filterQuery == null || filterQuery.length() == 0) {
                ...
                for (YailDictionary itemDict : ListAdapterWithRecyclerView.this.items) {
                    ...
                    if (o != null) {
                        filterString = filterString + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + o.toString().toLowerCase();
                    }
    ...
    public ListAdapterWithRecyclerView(ComponentContainer container2, YailList stringItems, int textMainColor2, float textMainSize2, int textMainFont2, int backgroundColor2, int selectionColor2) {
        this.container = container2;
        this.textMainSize = textMainSize2;
        this.textMainColor = textMainColor2;
        this.textMainFont = textMainFont2;
    ...
    public RvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TextViewUtil.setFontTypeface(textViewFirst, this.textMainFont, false, false);
        ...
        if (this.layoutType == 0 || this.layoutType == 3) {
            ...
            TextViewUtil.setFontTypeface(textViewSecond, this.textDetailFont, false, false);
