...
public final class HostAndPort implements Serializable {
    ...
    private static String[] getHostAndPortFromBracketedHost(String hostPortString) {
        ...
        Preconditions.checkArgument(z, "Bracketed host-port string must start with a bracket: %s", (Object) hostPortString);
        ...
        Preconditions.checkArgument(z2, "Invalid bracketed host/port: %s", (Object) hostPortString);
        ...
        Preconditions.checkArgument(z3, "Only a colon may follow a close bracket: %s", (Object) hostPortString);
