...
public final class InternetDomainName {
    ...
    private static final Joiner DOT_JOINER = Joiner.m49on('.');
    private static final Splitter DOT_SPLITTER = Splitter.m62on('.');
    private static final int MAX_DOMAIN_PART_LENGTH = 63;
    private static final int MAX_LENGTH = 253;
    private static final int MAX_PARTS = 127;
    private static final int NO_SUFFIX_FOUND = -1;
    private static final CharMatcher PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().mo15676or(DASH_MATCHER);
    ...
    InternetDomainName(String name2) {
        ...
        Preconditions.checkArgument(name3.length() <= 253, "Domain name too long: '%s':", (Object) name3);
        this.name = name3;
        this.parts = ImmutableList.copyOf(DOT_SPLITTER.split(name3));
        Preconditions.checkArgument(this.parts.size() > MAX_PARTS ? false : z, "Domain has too many parts: '%s'", (Object) name3);
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m51of(PublicSuffixType.REGISTRY));
    }
