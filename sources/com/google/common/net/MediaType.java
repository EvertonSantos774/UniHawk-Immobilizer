...
public final class MediaType {
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m50on("; ").withKeyValueSeparator("=");
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m94of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static MediaType createConstant(String type2, String subtype2) {
        MediaType mediaType = addKnownType(new MediaType(type2, subtype2, ImmutableListMultimap.m93of()));
    ...
    private static MediaType createConstantUtf8(String type2, String subtype2) {
        ...
        mediaType.parsedCharset = Optional.m51of(Charsets.UTF_8);
        return mediaType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (local == null) {
            ...
            while (it.hasNext()) {
                ...
                if (value == null) {
                    value = currentValue;
                    local = Optional.m51of(Charset.forName(value));
    ...
    public MediaType withParameter(String attribute, String value) {
        return withParameters(attribute, ImmutableSet.m123of(value));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType withCharset = withParameter(CHARSET_ATTRIBUTE, charset.name());
        withCharset.parsedCharset = Optional.m51of(charset);
        return withCharset;
    }
    ...
    /* renamed from: is */
    public boolean mo19286is(MediaType mediaTypeRange) {
    ...
    public static MediaType create(String type2, String subtype2) {
        MediaType mediaType = create(type2, subtype2, ImmutableListMultimap.m93of());
        mediaType.parsedCharset = Optional.absent();
        return mediaType;
    }
