...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* renamed from: C1 */
    private static final int f333C1 = -862048943;

    /* renamed from: C2 */
    private static final int f334C2 = 461845907;
    ...
    public static int mixK1(int k1) {
        return Integer.rotateLeft(k1 * f333C1, 15) * f334C2;
    }
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int nBytes, long update) {
            ...
            this.length += nBytes;
            if (this.shift >= 32) {
                this.f335h1 = Murmur3_32HashFunction.mixH1(this.f335h1, Murmur3_32HashFunction.mixK1((int) this.buffer));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            this.f335h1 ^= Murmur3_32HashFunction.mixK1((int) this.buffer);
            return Murmur3_32HashFunction.fmix(this.f335h1, this.length);
        }
    }
