...
public final class IntMath {
    ...
    @VisibleForTesting
    static int[] biggestBinomials = {ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, 65536, 2345, 477, FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_STOP, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    @VisibleForTesting
    static final int[] powersOf10 = {1, 10, 100, 1000, 10000, Form.MAX_PERMISSION_NONCE, 1000000, 10000000, 100000000, 1000000000};
    ...
    public static int log2(int x, RoundingMode mode) {
        MathPreconditions.checkPositive("x", x);
        switch (C13261.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
    ...
    public static int saturatedPow(int b, int k) {
        ...
        switch (b) {
            case -2:
                if (k >= 32) {
                    return (k & 1) + ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
                }
                return (k & 1) == 0 ? 1 << k : -1 << k;
            case -1:
                if ((k & 1) != 0) {
            ...
            default:
                int accum = 1;
                int limit = ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED + ((b >>> 31) & k & 1);
                while (true) {
                    switch (k) {
                        case 0:
                            return accum;
    ...
    public static int factorial(int n) {
        ...
        return n < factorials.length ? factorials[n] : ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
    }
