    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dataset) {
            ...
            for (int i2 = 0; i2 < this.indexes.length; i2++) {
                ...
                if (remainder2 == 0) {
                    hashMap.put(Integer.valueOf(this.indexes[i2]), Double.valueOf(dataset[quotient2]));
                } else {
                    hashMap.put(Integer.valueOf(this.indexes[i2]), Double.valueOf(Quantiles.interpolate(dataset[quotient2], dataset[quotient2 + 1], (double) remainder2, (double) this.scale)));
                }
            }
