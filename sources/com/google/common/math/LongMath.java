...
public final class LongMath {
    ...
    static final int[] biggestBinomials = {ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, HttpStatus.SC_PARTIAL_CONTENT, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    @VisibleForTesting
    ...
    public static int log2(long x, RoundingMode mode) {
        MathPreconditions.checkPositive("x", x);
        switch (C13281.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
    ...
    public static long saturatedAdd(long a, long b) {
        ...
        return z2 | z ? naiveSum : Long.MAX_VALUE + ((naiveSum >>> 63) ^ 1);
    }
    ...
    public static long saturatedSubtract(long a, long b) {
        ...
        return z2 | z ? naiveDifference : Long.MAX_VALUE + ((naiveDifference >>> 63) ^ 1);
    }
