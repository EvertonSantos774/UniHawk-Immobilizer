...
public final class UnsignedInts {
    ...
    public static int saturatedCast(long value) {
        ...
        if (value >= Declaration.TRANSIENT_ACCESS) {
            return -1;
        }
        return (int) value;
    }
    ...
    public static void sortDescending(int[] array, int fromIndex, int toIndex) {
        ...
        Preconditions.checkPositionIndexes(fromIndex, toIndex, array.length);
        for (int i = fromIndex; i < toIndex; i++) {
            array[i] = array[i] ^ ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
        }
        Arrays.sort(array, fromIndex, toIndex);
        for (int i2 = fromIndex; i2 < toIndex; i2++) {
            array[i2] = array[i2] ^ ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
        }
    }
