...
final class Types {
    ...
    public static final Joiner COMMA_JOINER = Joiner.m50on(", ").useForNull("null");
    /* access modifiers changed from: private */
    ...
    public static void disallowPrimitiveType(Type[] types, String usedAs) {
        ...
        for (Class<?> cls : types) {
            if (cls instanceof Class) {
                ...
                Preconditions.checkArgument(z, "Primitive type '%s' used as %s", (Object) cls2, (Object) usedAs);
            }
        }
    }
