...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m65on(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m217of(String resourceName2, ClassLoader loader2) {
    ...
    static abstract class Scanner {
        ...
        static ImmutableList<URL> parseJavaClassPath() {
            ...
            for (String entry : Splitter.m65on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
                try {
                    ...
                    try {
                        ...
                        ClassPath.logger.log(Level.WARNING, "malformed classpath entry: " + entry, e2);
                    }
                }
            }
            return urls.build();
    ...
    static final class DefaultScanner extends Scanner {
        ...
        public ImmutableSet<ResourceInfo> getResources() {
            ...
            for (Map.Entry<ClassLoader, String> entry : this.resources.entries()) {
                builder.add((Object) ResourceInfo.m217of(entry.getValue(), entry.getKey()));
            }
            return builder.build();
        }
