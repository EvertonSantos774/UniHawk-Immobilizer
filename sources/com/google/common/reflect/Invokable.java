...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
    ...
    public final TypeToken<? extends R> getReturnType() {
        return TypeToken.m221of(getGenericReturnType());
    }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i = 0; i < parameterTypes.length; i++) {
            builder.add((Object) new Parameter(this, i, TypeToken.m221of(parameterTypes[i]), annotations[i]));
        }
    ...
    public final ImmutableList<TypeToken<? extends Throwable>> getExceptionTypes() {
        ...
        for (Type type : getGenericExceptionTypes()) {
            builder.add((Object) TypeToken.m221of(type));
        }
        return builder.build();
    }

    public final <R1 extends R> Invokable<T, R1> returning(Class<R1> returnType) {
        return returning(TypeToken.m220of(returnType));
    }
    ...
    public TypeToken<T> getOwnerType() {
        return TypeToken.m220of(getDeclaringClass());
    }
