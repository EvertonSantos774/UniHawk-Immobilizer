...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public V remove(Object key) {
            ...
            V safeRemove = Maps.safeRemove(backingRowMap2, key);
    ...
    private class Column extends Maps.ViewCachingAbstractMap<R, V> {
        ...
        private class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public boolean retainAll(Collection<?> c) {
                return Column.this.removeFromColumnIf(Predicates.not(Predicates.m55in(c)));
            }
        }
        ...
        private class KeySet extends Maps.KeySet<R, V> {
            ...
            public boolean retainAll(Collection<?> c) {
                return Column.this.removeFromColumnIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m55in(c))));
            }
        }
        ...
        private class Values extends Maps.Values<R, V> {
            ...
            public boolean removeAll(Collection<?> c) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.m55in(c)));
            }

            public boolean retainAll(Collection<?> c) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m55in(c))));
            }
        }
    }
