...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m80of(), ImmutableList.m80of());
    ...
    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m118of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m119of(Range<K> range, V value) {
        return new ImmutableRangeMap<>(ImmutableList.m81of(range), ImmutableList.m81of(value));
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        return new ImmutableRangeMap<K, V>(new ImmutableList<Range<K>>() {
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> subRange) {
                ...
                return ImmutableRangeMap.m118of();
            }
        };
    }
