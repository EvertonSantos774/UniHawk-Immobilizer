...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo15643or(this);
    }
    ...
    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m70of() {
        return from(ImmutableList.m80of());
    }

    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m71of(@NullableDecl E element, E... elements) {
    ...
    public final Optional<E> first() {
        ...
        return iterator.hasNext() ? Optional.m51of(iterator.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (iterable instanceof List) {
            ...
            return Optional.m51of(list.get(list.size() - 1));
        }
        ...
        if (iterable instanceof SortedSet) {
            return Optional.m51of(((SortedSet) iterable).last());
        }
        do {
            current = iterator.next();
        } while (iterator.hasNext());
        return Optional.m51of(current);
    }
