...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m81of(Range.all()));
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m80of());
    @LazyInit
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m120of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m121of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m81of(range));
    }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> domain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m160of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (mergedRanges.isEmpty()) {
                return ImmutableRangeSet.m120of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        public Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m81of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
