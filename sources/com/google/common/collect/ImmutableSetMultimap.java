...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m129of() {
        return EmptyImmutableSetMultimap.INSTANCE;
    }

    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m130of(K k1, V v1) {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m131of(K k1, V v1, K k2, V v2) {
        Builder<K, V> builder = builder();
        builder.put((Object) k1, (Object) v1);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m132of(K k1, V v1, K k2, V v2, K k3, V v3) {
        Builder<K, V> builder = builder();
        builder.put((Object) k1, (Object) v1);
        builder.put((Object) k2, (Object) v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m133of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        Builder<K, V> builder = builder();
        builder.put((Object) k1, (Object) v1);
        builder.put((Object) k2, (Object) v2);
        builder.put((Object) k3, (Object) v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m134of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        Builder<K, V> builder = builder();
        builder.put((Object) k1, (Object) v1);
        builder.put((Object) k2, (Object) v2);
        builder.put((Object) k3, (Object) v3);
