...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m173of() {
        return SparseImmutableTable.EMPTY;
    }

    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m174of(R rowKey, C columnKey, V value) {
    ...
    public ImmutableMap<R, V> column(C columnKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(columnKey), ImmutableMap.m99of());
    }
    ...
    public ImmutableMap<C, V> row(R rowKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(rowKey), ImmutableMap.m99of());
    }
    ...
    static final class SerializedForm implements Serializable {
        ...
        public Object readResolve() {
            ...
            if (this.cellValues.length == 1) {
                return ImmutableTable.m174of(this.rowKeys[0], this.columnKeys[0], this.cellValues[0]);
            }
