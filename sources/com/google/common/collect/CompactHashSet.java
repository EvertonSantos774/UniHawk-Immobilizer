...
class CompactHashSet<E> extends AbstractSet<E> implements Serializable {
    ...
    private void resizeMeMaybe(int newSize) {
        ...
        if (newSize > entriesSize) {
            ...
            if (newCapacity < 0) {
                newCapacity = ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            }
    ...
    public Iterator<E> iterator() {
        return new Iterator<E>() {
            ...
            public void remove() {
                ...
                boolean unused = CompactHashSet.this.remove(CompactHashSet.this.elements[this.indexToRemove], CompactHashSet.getHash(CompactHashSet.this.entries[this.indexToRemove]));
