...
public final class Multisets {
    ...
    static abstract class ElementSet<E> extends Sets.ImprovedAbstractSet<E> {
        ...
        public boolean remove(Object o) {
            return multiset().remove(o, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) > 0;
        }
    ...
    public static <E> ImmutableMultiset<E> copyHighestCountFirst(Multiset<E> multiset) {
        Multiset.Entry<E>[] entries = (Multiset.Entry[]) ((Multiset.Entry[]) multiset.entrySet().toArray(new Multiset.Entry[0]));
