...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    class WrappedCollection extends AbstractCollection<V> {
        ...
        public boolean addAll(Collection<? extends V> collection) {
            ...
            int unused = AbstractMapBasedMultimap.this.totalSize = AbstractMapBasedMultimap.this.totalSize + (this.delegate.size() - oldSize);
            if (oldSize != 0) {
                return changed;
            }
            addToMap();
        ...
        public void clear() {
            ...
            if (oldSize != 0) {
                this.delegate.clear();
                int unused = AbstractMapBasedMultimap.this.totalSize = AbstractMapBasedMultimap.this.totalSize - oldSize;
                removeIfEmpty();
            }
        }
    ...
    class WrappedList extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements List<V> {
        ...
        public boolean addAll(int index, Collection<? extends V> c) {
            ...
            int unused = AbstractMapBasedMultimap.this.totalSize = AbstractMapBasedMultimap.this.totalSize + (getDelegate().size() - oldSize);
            if (oldSize != 0) {
                return changed;
            }
            addToMap();
    ...
    private class KeySet extends Maps.KeySet<K, Collection<V>> {
        ...
        public Iterator<K> iterator() {
            ...
            return new Iterator<K>() {
                ...
                public void remove() {
                    ...
                    int unused = AbstractMapBasedMultimap.this.totalSize = AbstractMapBasedMultimap.this.totalSize - collection.size();
                    collection.clear();
                    this.entry = null;
                }
            };
        ...
        public boolean remove(Object key) {
            ...
            if (collection != null) {
                ...
                collection.clear();
                int unused = AbstractMapBasedMultimap.this.totalSize = AbstractMapBasedMultimap.this.totalSize - count;
            }
            return count > 0;
        }
