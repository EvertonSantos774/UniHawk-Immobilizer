...
class ConfigurableNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    ConfigurableNetwork(NetworkBuilder<? super N, ? super E> builder) {
        this(builder, builder.nodeOrder.createMap(((Integer) builder.expectedNodeCount.mo15643or(10)).intValue()), builder.edgeOrder.createMap(builder.expectedEdgeCount.mo15643or(20).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E edge) {
        ...
        return EndpointPair.m180of((Network<?, ?>) this, nodeU, this.nodeConnections.get(nodeU).adjacentNode(edge));
    }
