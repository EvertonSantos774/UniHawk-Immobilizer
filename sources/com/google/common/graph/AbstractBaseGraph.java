...
abstract class AbstractBaseGraph<N> implements BaseGraph<N> {
    ...
    public Set<EndpointPair<N>> incidentEdges(N node) {
        ...
        return IncidentEdgeSet.m175of(this, node);
    }
    ...
    private static abstract class IncidentEdgeSet<N> extends AbstractSet<EndpointPair<N>> {
        ...
        /* renamed from: of */
        public static <N> IncidentEdgeSet<N> m175of(BaseGraph<N> graph2, N node2) {
        ...
        private static final class Directed<N> extends IncidentEdgeSet<N> {
            ...
            public UnmodifiableIterator<EndpointPair<N>> iterator() {
                ...
                }), Iterators.transform(Sets.difference(this.graph.successors(this.node), ImmutableSet.m123of(this.node)).iterator(), new Function<N, EndpointPair<N>>() {
