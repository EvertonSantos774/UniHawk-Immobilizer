...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
            ...
            public Set<EndpointPair<N>> edges() {
                ...
                return new AbstractSet<EndpointPair<N>>() {
                    ...
                    public boolean contains(@NullableDecl Object obj) {
                        ...
                        if (!C12571.this.isOrderingCompatible(endpointPair) || !C12571.this.nodes().contains(endpointPair.nodeU()) || !C12571.this.successors((Object) endpointPair.nodeU()).contains(endpointPair.nodeV())) {
                            return false;
                        }
                        return true;
                    }
    ...
    public Set<E> adjacentEdges(E edge) {
        ...
        return Sets.difference(Sets.union(incidentEdges(endpointPair.nodeU()), incidentEdges(endpointPair.nodeV())), ImmutableSet.m123of(edge));
    }
    ...
    public boolean hasEdgeConnecting(EndpointPair<N> endpoints) {
        ...
        if (isOrderingCompatible(endpoints) && !edgesConnecting(endpoints.nodeU(), endpoints.nodeV()).isEmpty()) {
            return true;
        }
        return false;
    }
