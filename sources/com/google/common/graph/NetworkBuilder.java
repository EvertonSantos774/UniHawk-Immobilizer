...
public final class NetworkBuilder<N, E> extends AbstractGraphBuilder<N> {
    ...
    public NetworkBuilder<N, E> expectedNodeCount(int expectedNodeCount) {
        this.expectedNodeCount = Optional.m51of(Integer.valueOf(Graphs.checkNonNegative(expectedNodeCount)));
        return this;
    }

    public NetworkBuilder<N, E> expectedEdgeCount(int expectedEdgeCount2) {
        this.expectedEdgeCount = Optional.m51of(Integer.valueOf(Graphs.checkNonNegative(expectedEdgeCount2)));
        return this;
    }
