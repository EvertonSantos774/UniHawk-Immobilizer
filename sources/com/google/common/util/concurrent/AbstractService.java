...
public abstract class AbstractService implements Service {
    ...
    private static final class StateSnapshot {
        ...
        StateSnapshot(Service.State internalState, boolean shutdownWhenStartupFinishes2, @NullableDecl Throwable failure2) {
            ...
            Preconditions.checkArgument(z ^ (internalState == Service.State.FAILED) ? false : z2, "A failure cause should be set if and only if the state is failed.  Got %s and %s instead.", (Object) internalState, (Object) failure2);
