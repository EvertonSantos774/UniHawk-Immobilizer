...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f298f;

        /* renamed from: g */
        private final Function<B, C> f299g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f299g = (Function) Preconditions.checkNotNull(g);
            this.f298f = (Function) Preconditions.checkNotNull(f);
        }

        public C apply(@NullableDecl A a) {
            return this.f299g.apply(this.f298f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f298f.equals(that.f298f) || !this.f299g.equals(that.f299g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f298f.hashCode() ^ this.f299g.hashCode();
        }

        public String toString() {
            return this.f299g + "(" + this.f298f + ")";
        }
    }
