...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m43is(char match) {
        return new C0953Is(match);
    }
    ...
    public static CharMatcher anyOf(CharSequence sequence) {
        switch (sequence.length()) {
            case 0:
                return none();
            case 1:
                return m43is(sequence.charAt(0));
            case 2:
    ...
    /* renamed from: or */
    public CharMatcher mo15676or(CharMatcher other) {
        return new C0954Or(this, other);
    }
    ...
    public CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(precomputedPositive(negatedCharacters, table, description.endsWith(".negate()") ? description.substring(0, description.length() - ".negate()".length()) : description + ".negate()")) {
    ...
    private static CharMatcher precomputedPositive(int totalCharacters, BitSet table, String description) {
        switch (totalCharacters) {
            case 0:
                return none();
            case 1:
                return m43is((char) table.nextSetBit(0));
            case 2:
    ...
    private static final class C0954Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C0954Or(CharMatcher a, CharMatcher b) {
            this.first = (CharMatcher) Preconditions.checkNotNull(a);
            this.second = (CharMatcher) Preconditions.checkNotNull(b);
        }
    ...
    private static final class C0953Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo15676or(CharMatcher other) {
            return other.matches(this.match) ? other : super.mo15676or(other);
        }
