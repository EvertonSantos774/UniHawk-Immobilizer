...
public class TokenRequest extends GenericData {
    ...
    public TokenRequest(HttpTransport transport2, JsonFactory jsonFactory2, GenericUrl tokenServerUrl2, String grantType2) {
        this(transport2, jsonFactory2, tokenServerUrl2, grantType2, TokenResponse.class);
    }

    public TokenRequest(HttpTransport transport2, JsonFactory jsonFactory2, GenericUrl tokenServerUrl2, String grantType2, Class<? extends TokenResponse> responseClass2) {
        ...
        setResponseClass(responseClass2);
    }
    ...
    public TokenRequest setScopes(Collection<String> scopes2) {
        this.scopes = scopes2 == null ? null : Joiner.m38on(' ').join(scopes2);
        return this;
    }
    ...
    public TokenRequest setResponseClass(Class<? extends TokenResponse> responseClass2) {
