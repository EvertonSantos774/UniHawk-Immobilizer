...
public final class ByteArrayContent extends AbstractInputStreamContent {
    ...
    public ByteArrayContent(String type, byte[] array, int offset2, int length2) {
        ...
        Preconditions.checkArgument(offset2 >= 0 && length2 >= 0 && offset2 + length2 <= array.length, "offset %s, length %s, array length %s", Integer.valueOf(offset2), Integer.valueOf(length2), Integer.valueOf(array.length));
        this.offset = offset2;
        this.length = length2;
    }
