...
public class HttpHeaders extends GenericData {
    ...
    public HttpHeaders setAuthorization(String authorization2) {
        return setAuthorization((List<String>) getAsList(authorization2));
    }
    ...
    public HttpHeaders addWarning(String warning2) {
        if (warning2 != null) {
            if (this.warning == null) {
                this.warning = getAsList(warning2);
            } else {
                this.warning.add(warning2);
            }
        }
        return this;
    }
    ...
    private static String toStringValue(Object headerValue) {
        if (headerValue instanceof Enum) {
            return FieldInfo.m36of((Enum<?>) (Enum) headerValue).getName();
        }
    ...
    public final void fromHttpHeaders(HttpHeaders headers) {
        try {
            ParseHeaderState state = new ParseHeaderState(this, (StringBuilder) null);
            serializeHeaders(headers, (StringBuilder) null, (StringBuilder) null, (Logger) null, new HeaderParsingFakeLevelHttpRequest(this, state));
            state.finish();
    ...
    private static final class ParseHeaderState {
        ...
        public ParseHeaderState(HttpHeaders headers, StringBuilder logger2) {
            ...
            this.classInfo = ClassInfo.m35of(cls, true);
            this.logger = logger2;
