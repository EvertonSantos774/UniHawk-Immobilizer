...
public class TestCertificates {
    ...
    public static JsonWebSignature getJsonWebSignature() throws IOException {
        if (jsonWebSignature == null) {
            ...
            int secondDot = JWS_SIGNATURE.indexOf(46, JWS_SIGNATURE.indexOf(46) + 1);
            jsonWebSignature = new JsonWebSignature(header, payload, Base64.decodeBase64(JWS_SIGNATURE.substring(secondDot + 1)), StringUtils.getBytesUtf8(JWS_SIGNATURE.substring(0, secondDot)));
        }
