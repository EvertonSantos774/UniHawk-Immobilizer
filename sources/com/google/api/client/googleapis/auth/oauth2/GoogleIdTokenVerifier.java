...
public class GoogleIdTokenVerifier extends IdTokenVerifier {
    ...
    public GoogleIdTokenVerifier(GooglePublicKeysManager publicKeys2) {
        this(new Builder(publicKeys2));
    }
    ...
    public static class Builder extends IdTokenVerifier.Builder {
        ...
        public Builder(GooglePublicKeysManager publicKeys2) {
            this.publicKeys = (GooglePublicKeysManager) Preconditions.checkNotNull(publicKeys2);
