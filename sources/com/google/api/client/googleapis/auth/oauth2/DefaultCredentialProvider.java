...
class DefaultCredentialProvider extends SystemEnvironmentProvider {
    ...
    private com.google.api.client.googleapis.auth.oauth2.GoogleCredential getCredentialUsingEnvironmentVariable(com.google.api.client.http.HttpTransport r10, com.google.api.client.json.JsonFactory r11) throws java.io.IOException {
        /*
            ...
            r1 = 0
            java.io.FileInputStream r2 = new java.io.FileInputStream     // Catch:{ IOException -> 0x0016 }
            r2.<init>(r0)     // Catch:{ IOException -> 0x0016 }
            com.google.api.client.googleapis.auth.oauth2.GoogleCredential r4 = com.google.api.client.googleapis.auth.oauth2.GoogleCredential.fromStream(r2, r10, r11)     // Catch:{ IOException -> 0x0045, all -> 0x0042 }
        ...
        L_0x0016:
            r3 = move-exception
        L_0x0017:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ all -> 0x003b }
            java.lang.String r5 = "Error reading credential file from environment variable %s, value '%s': %s"
            r6 = 3
            java.lang.Object[] r6 = new java.lang.Object[r6]     // Catch:{ all -> 0x003b }
            r7 = 0
            java.lang.String r8 = "GOOGLE_APPLICATION_CREDENTIALS"
            r6[r7] = r8     // Catch:{ all -> 0x003b }
            r7 = 1
            r6[r7] = r0     // Catch:{ all -> 0x003b }
            r7 = 2
            java.lang.String r8 = r3.getMessage()     // Catch:{ all -> 0x003b }
            r6[r7] = r8     // Catch:{ all -> 0x003b }
            java.lang.String r5 = java.lang.String.format(r5, r6)     // Catch:{ all -> 0x003b }
            r4.<init>(r5)     // Catch:{ all -> 0x003b }
            java.lang.Throwable r4 = com.google.api.client.googleapis.auth.oauth2.OAuth2Utils.exceptionWithCause(r4, r3)     // Catch:{ all -> 0x003b }
            java.io.IOException r4 = (java.io.IOException) r4     // Catch:{ all -> 0x003b }
    ...
    private com.google.api.client.googleapis.auth.oauth2.GoogleCredential getCredentialUsingWellKnownFile(com.google.api.client.http.HttpTransport r10, com.google.api.client.json.JsonFactory r11) throws java.io.IOException {
        /*
            ...
            com.google.api.client.googleapis.auth.oauth2.GoogleCredential r4 = com.google.api.client.googleapis.auth.oauth2.GoogleCredential.fromStream(r1, r10, r11)     // Catch:{ IOException -> 0x0038, all -> 0x0035 }
        ...
        L_0x0015:
            ...
            r7 = 0
            r6[r7] = r3     // Catch:{ all -> 0x002e }
            r7 = 1
            java.lang.String r8 = r2.getMessage()     // Catch:{ all -> 0x002e }
            r6[r7] = r8     // Catch:{ all -> 0x002e }
            java.lang.String r5 = java.lang.String.format(r5, r6)     // Catch:{ all -> 0x002e }
    ...
    private boolean useGAEStandardAPI() {
        ...
        try {
            try {
                ...
                if (environmentField.getType().getMethod("value", new Class[0]).invoke(environmentField.get((Object) null), new Object[0]) != null) {
                    return true;
                }
                return false;
