...
public final class MediaHttpUploader {
    ...
    /* renamed from: KB */
    private static final int f278KB = 1024;

    /* renamed from: MB */
    static final int f279MB = 1048576;
    ...
    private HttpResponse resumableUpload(GenericUrl initiationRequestUrl) throws IOException {
        ...
        try {
            ...
            while (true) {
                ...
                this.currentRequest.setContent(contentChunk.getContent());
    ...
    private static class ContentChunk {
        ...
        ContentChunk(AbstractInputStreamContent content2, String contentRange2) {
    ...
    public MediaHttpUploader setInitiationRequestMethod(String initiationRequestMethod2) {
        Preconditions.checkArgument(initiationRequestMethod2.equals("POST") || initiationRequestMethod2.equals("PUT") || initiationRequestMethod2.equals(HttpMethods.PATCH));
