...
class AndroidJsonParser extends JsonParser {
    ...
    AndroidJsonParser(AndroidJsonFactory factory2, JsonReader reader2) {
    ...
    public UnsignedInteger getUnsignedIntegerValue() {
        checkNumber();
        return UnsignedInteger.valueOf(this.currentText);
    }

    public UnsignedLong getUnsignedLongValue() {
        checkNumber();
        return UnsignedLong.valueOf(this.currentText);
    }
    ...
    public JsonToken nextToken() throws IOException {
        ...
        switch (C09171.$SwitchMap$android$util$JsonToken[peek.ordinal()]) {
            case 1:
                this.currentText = "[";
    ...
    /* renamed from: com.google.api.client.extensions.android3.json.AndroidJsonParser$1 */
