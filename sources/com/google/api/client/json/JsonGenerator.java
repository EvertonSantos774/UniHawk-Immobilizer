...
public abstract class JsonGenerator implements Closeable, Flushable {
    ...
    private void serialize(boolean isJsonString, Object value) throws IOException {
        ...
        if (value != null) {
            ...
            if (Data.isNull(value)) {
            ...
            } else if (((value instanceof Iterable) || valueClass.isArray()) && !(value instanceof Map) && !(value instanceof GenericData)) {
                writeStartArray();
                ...
                String name = FieldInfo.m36of((Enum<?>) (Enum) value).getName();
                if (name == null) {
                    writeNull();
                } else {
                    writeString(name);
                ...
                ClassInfo classInfo = isMapNotGenericData ? null : ClassInfo.m34of(valueClass);
