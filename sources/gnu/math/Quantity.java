...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo11851re() {
        return number().mo11851re();
    }

    /* renamed from: im */
    public RealNum mo11850im() {
        return number().mo11850im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo11851re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo11850im().doubleValue();
    }
