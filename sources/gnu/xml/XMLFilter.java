...
public class XMLFilter implements DocumentHandler, ContentHandler, SourceLocator, XConsumer, PositionConsumer {
    ...
    public int getLineNumber() {
        int line;
        if (this.f239in != null && (line = this.f239in.getLineNumber()) >= 0) {
            return line + 1;
        }
        return -1;
    }
    ...
    public int getColumnNumber() {
        int col;
        if (this.f239in == null || (col = this.f239in.getColumnNumber()) <= 0) {
            return -1;
        }
        return col;
    }
