...
public class CompileArith implements Inlineable {
    ...
    public static CompileArith forDiv(Object proc2) {
        return new CompileArith(proc2, ((DivideOp) proc2).f51op);
    }

    public static CompileArith forBitwise(Object proc2) {
        return new CompileArith(proc2, ((BitwiseOp) proc2).f51op);
    }
    ...
    public void compile(ApplyExp exp, Compilation comp, Target target) {
        ...
        if (len == 0) {
            ...
            int kind1 = Arithmetic.classifyType(args[0].getType());
            int kind2 = Arithmetic.classifyType(args[1].getType());
            int kind = getReturnKind(kind1, kind2, this.f52op);
            ...
            if (this.f52op >= 4 && this.f52op <= 8) {
                DivideOp dproc = (DivideOp) this.proc;
                if (dproc.f51op != 4 || (kind > 4 && kind < 6 && kind > 9)) {
                    if ((dproc.f51op == 5 && kind <= 10 && kind != 7) || (dproc.f51op == 4 && kind == 10)) {
                        kind = 8;
                    } else if (((dproc.f51op != 7 && (dproc.f51op != 6 || kind > 4)) || !(dproc.getRoundingMode() == 3 || kind == 4 || kind == 7 || kind == 8)) && !(dproc.f51op == 8 && (dproc.getRoundingMode() == 3 || kind == 4))) {
                        ApplyExp.compile(exp, comp, target);
                        return;
                    }
                }
            }
            if (this.f52op == 4 && kind <= 10 && kind != 8 && kind != 7) {
                if (kind == 6 || kind > 4) {
            ...
            } else if (kind == 4 && (this.f52op == 1 || this.f52op == 3 || this.f52op == 2 || this.f52op == 13 || this.f52op == 14 || this.f52op == 15 || this.f52op == 7 || this.f52op == 8 || (this.f52op >= 9 && this.f52op <= 11))) {
                compileIntNum(args[0], args[1], kind1, kind2, comp);
            } else if (kind == 1 || kind == 2 || ((kind == 7 || kind == 8) && (this.f52op <= 8 || this.f52op >= 13))) {
                Target wtarget2 = StackTarget.getInstance(wtype2);
                CodeAttr code = comp.getCode();
                for (int i = 0; i < len; i++) {
                    if (i == 1 && this.f52op >= 9 && this.f52op <= 12) {
    ...
    public Type getReturnType(Expression[] args) {
        return Arithmetic.kindType(adjustReturnKind(getReturnKind(args), this.f52op));
    }
    ...
    public static Expression validateApplyNumberPredicate(ApplyExp exp, InlineCalls visitor, Type required, Procedure proc2) {
        int i = ((NumberPredicate) proc2).f56op;
        Expression[] args = exp.getArgs();
