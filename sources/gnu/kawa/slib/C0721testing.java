...
/* renamed from: gnu.kawa.slib.testing */
/* compiled from: testing.scm */
public class C0721testing extends ModuleBody {
    ...
    public static final C0721testing $instance = new C0721testing();
    ...
    public static LList testRunnerGroupPath(Object runner) {
        try {
            ...
            try {
                return C0731lists.reverse((LList) testRunnerGroupStack);
            } catch (ClassCastException e) {
    ...
    static Object $PcTestAnySpecifierMatches(Object list, Object runner) {
        ...
        for (Object l = list; !C0731lists.isNull(l); l = C0731lists.cdr.apply1(l)) {
            if ($PcTestSpecificierMatches(C0731lists.car.apply1(l), runner) != Boolean.FALSE) {
                result = Boolean.TRUE;
            }
        }
        return result;
    ...
    public static java.lang.Object $PcTestShouldExecute(java.lang.Object r8) {
        ...
        L_0x007a:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: gnu.kawa.slib.C0721testing.$PcTestShouldExecute(java.lang.Object):java.lang.Object");
    }
    ...
    public static void $PcTestBegin(Object suite$Mnname, Object count) {
        ...
        try {
            ...
            try {
                try {
                    try {
                        $PcTestRunnerSkipSave$Ex((test$Mnrunner) runner, C0731lists.cons($PcTestRunnerSkipList((test$Mnrunner) runner), $PcTestRunnerSkipSave((test$Mnrunner) runner)));
                        try {
                            try {
                                try {
                                    $PcTestRunnerFailSave$Ex((test$Mnrunner) runner, C0731lists.cons($PcTestRunnerFailList((test$Mnrunner) runner), $PcTestRunnerFailSave((test$Mnrunner) runner)));
                                    try {
                                        try {
                                            try {
                                                $PcTestRunnerCountList$Ex((test$Mnrunner) runner, C0731lists.cons(C0731lists.cons($PcTestRunnerTotalCount((test$Mnrunner) runner), count), $PcTestRunnerCountList((test$Mnrunner) runner)));
                                                try {
                                                    try {
                                                        testRunnerGroupStack$Ex((test$Mnrunner) runner, C0731lists.cons(suite$Mnname, testRunnerGroupStack((test$Mnrunner) runner)));
                                                    } catch (ClassCastException e) {
                                                        throw new WrongType(e, "test-runner-group-stack", 0, runner);
                                                    }
                                                } catch (ClassCastException e2) {
    ...
    public static Boolean testOnGroupBeginSimple(Object runner, Object suite$Mnname, Object count) {
        ...
        try {
            if (C0731lists.isNull(testRunnerGroupStack((test$Mnrunner) runner))) {
    ...
    public static Boolean testOnGroupEndSimple(Object runner) {
        try {
            ...
            if (ports.isOutputPort(log)) {
                ...
                try {
                    ports.display(C0731lists.car.apply1(testRunnerGroupStack((test$Mnrunner) runner)), log);
                    ports.newline(log);
                } catch (ClassCastException e) {
                    throw new WrongType(e, "test-runner-group-stack", 0, runner);
                }
    ...
    static Object $PcTestFormatLine(Object runner) {
        try {
            ...
            Object source$Mnfile = C0731lists.assq(Lit4, line$Mninfo);
            Object source$Mnline = C0731lists.assq(Lit5, line$Mninfo);
            String file = source$Mnfile != Boolean.FALSE ? C0731lists.cdr.apply1(source$Mnfile) : "";
            ...
            objArr[0] = file;
            objArr[1] = ":";
            Object apply1 = C0731lists.cdr.apply1(source$Mnline);
            try {
    ...
    public static Object $PcTestEnd(Object suite$Mnname, Object line$Mninfo) {
        ...
        try {
            ...
            try {
                ...
                if (C0731lists.isNull(groups)) {
                    misc.error$V(strings.stringAppend(line, "test-end not in a group"), new Object[0]);
                }
                if (suite$Mnname == Boolean.FALSE ? suite$Mnname != Boolean.FALSE : !IsEqual.apply(suite$Mnname, C0731lists.car.apply1(groups))) {
                    try {
                        Scheme.applyToArgs.apply4(testRunnerOnBadEndName((test$Mnrunner) r), r, suite$Mnname, C0731lists.car.apply1(groups));
                    } catch (ClassCastException e) {
                ...
                try {
                    ...
                    Object expected$Mncount = C0731lists.cdar.apply1(count$Mnlist);
                    Object saved$Mncount = C0731lists.caar.apply1(count$Mnlist);
                    try {
                        ...
                        try {
                            ...
                            try {
                                try {
                                    testRunnerGroupStack$Ex((test$Mnrunner) r, C0731lists.cdr.apply1(testRunnerGroupStack((test$Mnrunner) r)));
                                    try {
                                        try {
                                            $PcTestRunnerSkipList$Ex((test$Mnrunner) r, C0731lists.car.apply1($PcTestRunnerSkipSave((test$Mnrunner) r)));
                                            try {
                                                try {
                                                    $PcTestRunnerSkipSave$Ex((test$Mnrunner) r, C0731lists.cdr.apply1($PcTestRunnerSkipSave((test$Mnrunner) r)));
                                                    try {
                                                        try {
                                                            $PcTestRunnerFailList$Ex((test$Mnrunner) r, C0731lists.car.apply1($PcTestRunnerFailSave((test$Mnrunner) r)));
                                                            try {
                                                                try {
                                                                    $PcTestRunnerFailSave$Ex((test$Mnrunner) r, C0731lists.cdr.apply1($PcTestRunnerFailSave((test$Mnrunner) r)));
                                                                    try {
                                                                        $PcTestRunnerCountList$Ex((test$Mnrunner) r, C0731lists.cdr.apply1(count$Mnlist));
                                                                        try {
                                                                            if (!C0731lists.isNull(testRunnerGroupStack((test$Mnrunner) r))) {
                                                                                return Values.empty;
                                                                            }
                                                                            try {
    ...
    static Object testOnTestBeginSimple(Object runner) {
        try {
            ...
            try {
                ...
                Object source$Mnfile = C0731lists.assq(Lit4, results);
                Object source$Mnline = C0731lists.assq(Lit5, results);
                Object source$Mnform = C0731lists.assq(Lit6, results);
                Object test$Mnname = C0731lists.assq(Lit7, results);
    ...
    public static Object testOnTestEndSimple(Object runner) {
        try {
            Object log = testRunnerAuxValue((test$Mnrunner) runner);
            try {
                Object p = C0731lists.assq(Lit1, testResultAlist((test$Mnrunner) runner));
                Object kind = p != Boolean.FALSE ? C0731lists.cdr.apply1(p) : Boolean.FALSE;
                if (C0731lists.memq(kind, Lit8) != Boolean.FALSE) {
                    try {
                        Object results = testResultAlist((test$Mnrunner) runner);
                        Object source$Mnfile = C0731lists.assq(Lit4, results);
                        Object source$Mnline = C0731lists.assq(Lit5, results);
                        ...
                        if (!(source$Mnfile == Boolean.FALSE && source$Mnline == Boolean.FALSE)) {
                            if (source$Mnfile != Boolean.FALSE) {
                                ports.display(C0731lists.cdr.apply1(source$Mnfile));
                            }
                            ports.display(":");
                            if (source$Mnline != Boolean.FALSE) {
                                ports.display(C0731lists.cdr.apply1(source$Mnline));
                            }
                            ports.display(": ");
                        }
                        ...
                        if (test$Mnname != Boolean.FALSE) {
                            ...
                            ports.display(C0731lists.cdr.apply1(test$Mnname));
                        }
                        ports.newline();
                    } catch (ClassCastException e) {
                        throw new WrongType(e, "test-result-alist", 0, runner);
                ...
                ports.newline(log);
                try {
                    for (Object list = testResultAlist((test$Mnrunner) runner); C0731lists.isPair(list); list = C0731lists.cdr.apply1(list)) {
                        Object pair = C0731lists.car.apply1(list);
                        if (C0731lists.memq(C0731lists.car.apply1(pair), Lit10) == Boolean.FALSE) {
    ...
    static Object $PcTestWriteResult1(Object pair, Object port) {
        ports.display("  ", port);
        ports.display(C0731lists.car.apply1(pair), port);
        ports.display(": ", port);
        ports.write(C0731lists.cdr.apply1(pair), port);
        ports.newline(port);
        return Values.empty;
    }
    ...
    public static Object testResultSet$Ex(Object runner, Object pname, Object value) {
        try {
            ...
            Object p = C0731lists.assq(pname, alist);
            if (p != Boolean.FALSE) {
                try {
                    C0731lists.setCdr$Ex((Pair) p, value);
                    return Values.empty;
                } catch (ClassCastException e) {
                ...
                try {
                    testResultAlist$Ex((test$Mnrunner) runner, C0731lists.cons(C0731lists.cons(pname, value), alist));
                    return Values.empty;
                } catch (ClassCastException e2) {
                    throw new WrongType(e2, "test-result-alist!", 0, runner);
                }
    ...
    public static void testResultRemove(Object runner, Object pname) {
        ...
        try {
            Object alist = testResultAlist((test$Mnrunner) runner);
            frame6.f223p = C0731lists.assq(pname, alist);
            if (frame6.f223p != Boolean.FALSE) {
                try {
    ...
    /* renamed from: gnu.kawa.slib.testing$frame */
    /* compiled from: testing.scm */
    public class frame extends ModuleBody {
        ...
        public Object lambda4loop(Object r) {
            if (r == this.f223p) {
                return C0731lists.cdr.apply1(r);
            }
            return C0731lists.cons(C0731lists.car.apply1(r), lambda4loop(C0731lists.cdr.apply1(r)));
        }
    }
    ...
    public static Object testResultKind$V(Object[] argsArray) {
        ...
        if (C0731lists.isPair(rest)) {
            runner = C0731lists.car.apply1(rest);
        } else {
        ...
        try {
            Object p = C0731lists.assq(Lit1, testResultAlist((test$Mnrunner) runner));
            if (p != Boolean.FALSE) {
                return C0731lists.cdr.apply1(p);
            }
            return Boolean.FALSE;
        } catch (ClassCastException e) {
            throw new WrongType(e, "test-result-alist", 0, runner);
    ...
    public static Object isTestPassed$V(Object[] argsArray) {
        Object obj;
        LList rest = LList.makeList(argsArray, 0);
        Object runner = C0731lists.isPair(rest) ? C0731lists.car.apply1(rest) : testRunnerGet();
        try {
            Object p = C0731lists.assq(Lit1, testResultAlist((test$Mnrunner) runner));
            if (p != Boolean.FALSE) {
                obj = C0731lists.cdr.apply1(p);
            } else {
                obj = Boolean.FALSE;
            }
            return C0731lists.memq(obj, Lit11);
        } catch (ClassCastException e) {
            throw new WrongType(e, "test-result-alist", 0, runner);
        }
    }
    ...
    static Pair $PcTestSourceLine2(Object form) {
        ...
        Object line$Mnpair = line != Boolean.FALSE ? LList.list1(C0731lists.cons(Lit5, line)) : LList.Empty;
        Pair cons = C0731lists.cons(Lit6, std_syntax.syntaxObject$To$Datum(form));
        if (file != Boolean.FALSE) {
            line$Mnpair = C0731lists.cons(C0731lists.cons(Lit4, file), line$Mnpair);
        }
        return C0731lists.cons(cons, line$Mnpair);
    }
    ...
    public static boolean $PcTestOnTestBegin(Object r) {
        ...
        try {
            ...
            try {
                Object p = C0731lists.assq(Lit1, testResultAlist((test$Mnrunner) r));
                return ((simpleSymbol == (p != Boolean.FALSE ? C0731lists.cdr.apply1(p) : Boolean.FALSE) ? 1 : 0) + 1) & true;
            } catch (ClassCastException e) {
    ...
    public static Object testRunnerTestName(Object runner) {
        try {
            Object p = C0731lists.assq(Lit7, testResultAlist((test$Mnrunner) runner));
            return p != Boolean.FALSE ? C0731lists.cdr.apply1(p) : "";
        } catch (ClassCastException e) {
            throw new WrongType(e, "test-result-alist", 0, runner);
        }
    }

    /* renamed from: gnu.kawa.slib.testing$frame0 */
    /* compiled from: testing.scm */
    ...
    public static Object testApply$V(Object first, Object[] argsArray) {
        ...
        if (r != Boolean.FALSE) {
            try {
                ...
                if (C0731lists.isNull(frame12.rest)) {
                    try {
                        try {
                            $PcTestRunnerRunList$Ex((test$Mnrunner) r, C0731lists.reverse$Ex((LList) run$Mnlist));
                    ...
                    try {
                        ...
                        if (run$Mnlist == Boolean.TRUE) {
                            ...
                            cons = C0731lists.cons(frame12.first, run$Mnlist);
                        }
            ...
            frame12.f224r = testRunnerCreate();
            ...
            Object obj = frame12.f224r;
            try {
                return applyToArgs.apply2(testRunnerOnFinal((test$Mnrunner) obj), frame12.f224r);
            } catch (ClassCastException e6) {
    ...
    /* renamed from: gnu.kawa.slib.testing$frame1 */
    /* compiled from: testing.scm */
    public class frame1 extends ModuleBody {
        ...
        public Object lambda6() {
            return ((Procedure) C0721testing.test$Mnrunner$Mncurrent).apply1(this.first);
        }

        /* access modifiers changed from: package-private */
        public Object lambda7() {
            return Scheme.apply.apply2(C0721testing.test$Mnapply, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda10() {
            return Scheme.apply.apply3(C0721testing.test$Mnapply, this.first, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda9() {
            return ((Procedure) C0721testing.test$Mnrunner$Mncurrent).apply1(this.f224r);
        }
        ...
        public Object lambda11() {
            return ((Procedure) C0721testing.test$Mnrunner$Mncurrent).apply1(this.saved$Mnrunner);
        }

        /* access modifiers changed from: package-private */
        public Object lambda8() {
            return ((Procedure) C0721testing.test$Mnrunner$Mncurrent).apply1(this.saved$Mnrunner$1);
        }
    ...
    /* renamed from: gnu.kawa.slib.testing$frame2 */
    /* compiled from: testing.scm */
    public class frame2 extends ModuleBody {
        ...
        public boolean lambda12(Object runner) {
            this.f225i = AddOp.$Pl.apply2(this.f225i, C0721testing.Lit13);
            Object apply2 = Scheme.numGEq.apply2(this.f225i, this.f226n);
            try {
                boolean x = ((Boolean) apply2).booleanValue();
                return x ? ((Boolean) Scheme.numLss.apply2(this.f225i, AddOp.$Pl.apply2(this.f226n, this.count))).booleanValue() : x;
            } catch (ClassCastException e) {
                throw new WrongType(e, "x", -2, apply2);
            }
        }
    ...
    /* renamed from: gnu.kawa.slib.testing$frame3 */
    /* compiled from: testing.scm */
    public class frame3 extends ModuleBody {
        ...
        public Object lambda13(Object runner) {
            ...
            for (Object obj = this.pred$Mnlist; !C0731lists.isNull(obj); obj = C0731lists.cdr.apply1(obj)) {
                if (Scheme.applyToArgs.apply2(C0731lists.car.apply1(obj), runner) == Boolean.FALSE) {
    ...
    /* renamed from: gnu.kawa.slib.testing$frame4 */
    /* compiled from: testing.scm */
    ...
    /* renamed from: gnu.kawa.slib.testing$frame5 */
    /* compiled from: testing.scm */
    public class frame5 extends ModuleBody {
        ...
        public boolean lambda15(Object runner) {
            return IsEqual.apply(this.name, C0721testing.testRunnerTestName(runner));
        }
