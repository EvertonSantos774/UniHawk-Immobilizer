...
public class srfi1 extends ModuleBody {
    ...
    public static final ModuleMethod f450break;
    ...
    static {
        ...
        f450break = new ModuleMethod(srfi1, 164, Lit80, 8194);
    ...
    public final void run(CallContext $ctx) {
        ...
        first = C0731lists.car;
        second = C0731lists.cadr;
        third = C0731lists.caddr;
        fourth = C0731lists.cadddr;
        map$Mnin$Mnorder = Scheme.map;
    }

    public static Pair xcons(Object d, Object a) {
        return C0731lists.cons(a, d);
    }
    ...
    public static Object makeList$V(Object len, Object[] argsArray) {
        ...
        if (C0731lists.isNull(maybe$Mnelt)) {
            elt = Boolean.FALSE;
        } else if (C0731lists.isNull(C0731lists.cdr.apply1(maybe$Mnelt))) {
            elt = C0731lists.car.apply1(maybe$Mnelt);
        } else {
            elt = misc.error$V("Too many arguments to MAKE-LIST", new Object[]{C0731lists.cons(len, maybe$Mnelt)});
        }
        Object obj = LList.Empty;
        Object i = len;
        while (Scheme.numLEq.apply2(i, Lit0) == Boolean.FALSE) {
            i = AddOp.$Mn.apply2(i, Lit1);
            obj = C0731lists.cons(elt, obj);
        }
        return obj;
    }
    ...
    public static Object listTabulate(Object len, Procedure proc) {
        ...
        while (Scheme.numLss.apply2(i, Lit0) == Boolean.FALSE) {
            ...
            obj = C0731lists.cons(proc.apply1(i), obj);
            i = i2;
        }
        return obj;
    }
    ...
    public static LList listCopy(LList lis) {
        ...
        while (C0731lists.isPair(lis)) {
            Pair p = C0731lists.cons(C0731lists.car.apply1(lis), LList.Empty);
            if (prev == LList.Empty) {
                result = p;
            } else {
                try {
                    C0731lists.setCdr$Ex((Pair) prev, p);
                } catch (ClassCastException e) {
                    throw new WrongType(e, "set-cdr!", 1, (Object) prev);
                }
            }
            prev = p;
            lis = (LList) C0731lists.cdr.apply1(lis);
        }
        return result;
    }
    ...
    public static Pair circularList$V(Object val1, Object[] argsArray) {
        Pair ans = C0731lists.cons(val1, LList.makeList(argsArray, 0));
        Object lastPair = lastPair(ans);
        try {
            C0731lists.setCdr$Ex((Pair) lastPair, ans);
            return ans;
        } catch (ClassCastException e) {
    ...
    public static Object isProperList(Object x) {
        Object lag = x;
        while (C0731lists.isPair(x)) {
            Object x2 = C0731lists.cdr.apply1(x);
            if (!C0731lists.isPair(x2)) {
                return C0731lists.isNull(x2) ? Boolean.TRUE : Boolean.FALSE;
            }
            x = C0731lists.cdr.apply1(x2);
            lag = C0731lists.cdr.apply1(lag);
            boolean x3 = ((x == lag ? 1 : 0) + 1) & true;
            if (!x3) {
                return x3 ? Boolean.TRUE : Boolean.FALSE;
            }
        }
        return C0731lists.isNull(x) ? Boolean.TRUE : Boolean.FALSE;
    }
    ...
    public static Object isDottedList(Object x) {
        ...
        while (C0731lists.isPair(x)) {
            Object x2 = C0731lists.cdr.apply1(x);
            if (!C0731lists.isPair(x2)) {
                return C0731lists.isNull(x2) ? Boolean.FALSE : Boolean.TRUE;
            }
            x = C0731lists.cdr.apply1(x2);
            lag = C0731lists.cdr.apply1(lag);
            boolean x3 = ((x == lag ? 1 : 0) + 1) & true;
        ...
        return C0731lists.isNull(x) ? Boolean.FALSE : Boolean.TRUE;
    }
    ...
    public static Object isCircularList(Object x) {
        ...
        Object lag = x;
        do {
            boolean x3 = C0731lists.isPair(x);
            if (!x3) {
                return x3 ? Boolean.TRUE : Boolean.FALSE;
            }
            Object x4 = C0731lists.cdr.apply1(x);
            boolean x5 = C0731lists.isPair(x4);
            if (!x5) {
                return x5 ? Boolean.TRUE : Boolean.FALSE;
            }
            x = C0731lists.cdr.apply1(x4);
            lag = C0731lists.cdr.apply1(lag);
            if (x == lag) {
                x2 = true;
                continue;
    ...
    public static boolean isNotPair(Object x) {
        return ((C0731lists.isPair(x) ? 1 : 0) + true) & true;
    }
    ...
    public static Object list$Eq$V(Object $Eq, Object[] argsArray) {
        ...
        boolean x = C0731lists.isNull(lists);
        if (!x) {
            Object list$Mna = C0731lists.car.apply1(lists);
            Object apply1 = C0731lists.cdr.apply1(lists);
            while (true) {
                boolean x2 = C0731lists.isNull(apply1);
                if (x2) {
                    return x2 ? Boolean.TRUE : Boolean.FALSE;
                }
                Object list$Mnb = C0731lists.car.apply1(apply1);
                apply1 = C0731lists.cdr.apply1(apply1);
                    ...
                    while (true) {
                        ...
                        if (isNullList(list$Mna) != Boolean.FALSE) {
                            ...
                            try {
                                ...
                                Object x5 = Scheme.applyToArgs.apply3($Eq, C0731lists.car.apply1(list$Mna), C0731lists.car.apply1(list$Mnb2));
                                if (x5 == Boolean.FALSE) {
                                    return x5;
                                }
                                list$Mna = C0731lists.cdr.apply1(list$Mna);
                                list$Mnb = C0731lists.cdr.apply1(list$Mnb2);
                            } catch (ClassCastException e) {
    ...
    public static Object fifth(Object x) {
        return C0731lists.car.apply1(C0731lists.cddddr.apply1(x));
    }

    public static Object sixth(Object x) {
        return C0731lists.cadr.apply1(C0731lists.cddddr.apply1(x));
    }

    public static Object seventh(Object x) {
        return C0731lists.caddr.apply1(C0731lists.cddddr.apply1(x));
    }

    public static Object eighth(Object x) {
        return C0731lists.cadddr.apply1(C0731lists.cddddr.apply1(x));
    }

    public static Object ninth(Object x) {
        return C0731lists.car.apply1(C0731lists.cddddr.apply1(C0731lists.cddddr.apply1(x)));
    }

    public static Object tenth(Object x) {
        return C0731lists.cadr.apply1(C0731lists.cddddr.apply1(C0731lists.cddddr.apply1(x)));
    }

    public static Object car$PlCdr(Object pair) {
        return misc.values(C0731lists.car.apply1(pair), C0731lists.cdr.apply1(pair));
    }
    ...
    public static java.lang.Object take(java.lang.Object r8, gnu.math.IntNum r9) {
        ...
        L_0x0003:
            ...
            r3 = r0
            gnu.lists.LList r3 = kawa.lib.C0731lists.reverse$Ex(r3)
            return r3
        L_0x0016:
            gnu.expr.GenericProc r3 = kawa.lib.C0731lists.cdr
            ...
            gnu.expr.GenericProc r3 = kawa.lib.C0731lists.car
            java.lang.Object r3 = r3.apply1(r8)
            gnu.lists.Pair r2 = kawa.lib.C0731lists.cons(r3, r4)
            r4 = r2
            r8 = r1
            goto L_0x0003
        L_0x0031:
    ...
    public static java.lang.Object drop(java.lang.Object r5, gnu.math.IntNum r6) {
        ...
        L_0x0000:
            ...
            return r5
        L_0x000b:
            gnu.expr.GenericProc r1 = kawa.lib.C0731lists.cdr
    ...
    public static Object take$Ex(Object lis, IntNum k) {
        ...
        try {
            C0731lists.setCdr$Ex((Pair) drop2, LList.Empty);
            return lis;
        } catch (ClassCastException e) {
    ...
    public static Object takeRight(Object lis, IntNum k) {
        Object lag = lis;
        for (Object drop2 = drop(lis, k); C0731lists.isPair(drop2); drop2 = C0731lists.cdr.apply1(drop2)) {
            lag = C0731lists.cdr.apply1(lag);
        }
        return lag;
    }
    ...
    public static Object lambda1recur(Object lag, Object lead) {
        return C0731lists.isPair(lead) ? C0731lists.cons(C0731lists.car.apply1(lag), lambda1recur(C0731lists.cdr.apply1(lag), C0731lists.cdr.apply1(lead))) : LList.Empty;
    }

    public static Object dropRight$Ex(Object lis, IntNum k) {
        Object lead = drop(lis, k);
        if (!C0731lists.isPair(lead)) {
            return LList.Empty;
        }
        Object lag = lis;
        for (Object lead2 = C0731lists.cdr.apply1(lead); C0731lists.isPair(lead2); lead2 = C0731lists.cdr.apply1(lead2)) {
            lag = C0731lists.cdr.apply1(lag);
        }
        try {
            C0731lists.setCdr$Ex((Pair) lag, LList.Empty);
            return lis;
        } catch (ClassCastException e) {
    ...
    public static java.lang.Object splitAt(java.lang.Object r7, gnu.math.IntNum r8) {
        ...
        L_0x0003:
            ...
            gnu.lists.LList r5 = kawa.lib.C0731lists.reverse$Ex(r1)
            r3[r4] = r5
            r3[r6] = r7
        ...
        L_0x0020:
            ...
            gnu.lists.Pair r1 = kawa.lib.C0731lists.cons(r3, r1)
            gnu.expr.GenericProc r3 = kawa.lib.C0731lists.cdr
    ...
    public static Object splitAt$Ex(Object x, IntNum k) {
        ...
        Object suffix = C0731lists.cdr.apply1(prev);
        try {
            C0731lists.setCdr$Ex((Pair) prev, LList.Empty);
    ...
    public static Object last(Object lis) {
        try {
            return C0731lists.car.apply1(lastPair((Pair) lis));
        } catch (ClassCastException e) {
    ...
    public static java.lang.Object lastPair(java.lang.Object r2) {
        ...
        L_0x0000:
            ...
            boolean r1 = kawa.lib.C0731lists.isPair(r0)
    ...
    public static LList unzip1(Object lis) {
        ...
        while (arg0 != LList.Empty) {
            try {
                ...
                obj = Pair.make(C0731lists.car.apply1(arg02.getCar()), obj);
                arg0 = arg03;
            } catch (ClassCastException e) {
    ...
    public class frame extends ModuleBody {
        public static Object lambda2recur(Object lis) {
            ...
            frame0.elt = C0731lists.car.apply1(frame0.lis);
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda3() {
            return frame.lambda2recur(C0731lists.cdr.apply1(this.lis));
        }

        /* access modifiers changed from: package-private */
        public Object lambda4(Object a, Object b) {
            return misc.values(C0731lists.cons(C0731lists.car.apply1(this.elt), a), C0731lists.cons(C0731lists.cadr.apply1(this.elt), b));
        }
    ...
    public class frame1 extends ModuleBody {
        public static Object lambda5recur(Object lis) {
            ...
            frame2.elt = C0731lists.car.apply1(frame2.lis);
    ...
    public class frame2 extends ModuleBody {
        ...
        public Object lambda6() {
            return frame1.lambda5recur(C0731lists.cdr.apply1(this.lis));
        }

        /* access modifiers changed from: package-private */
        public Object lambda7(Object a, Object b, Object c) {
            return misc.values(C0731lists.cons(C0731lists.car.apply1(this.elt), a), C0731lists.cons(C0731lists.cadr.apply1(this.elt), b), C0731lists.cons(C0731lists.caddr.apply1(this.elt), c));
        }
    ...
    public class frame3 extends ModuleBody {
        public static Object lambda8recur(Object lis) {
            ...
            frame4.elt = C0731lists.car.apply1(frame4.lis);
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda10(Object a, Object b, Object c, Object d) {
            return misc.values(C0731lists.cons(C0731lists.car.apply1(this.elt), a), C0731lists.cons(C0731lists.cadr.apply1(this.elt), b), C0731lists.cons(C0731lists.caddr.apply1(this.elt), c), C0731lists.cons(C0731lists.cadddr.apply1(this.elt), d));
        }

        /* access modifiers changed from: package-private */
        public Object lambda9() {
            return frame3.lambda8recur(C0731lists.cdr.apply1(this.lis));
        }
    ...
    public class frame5 extends ModuleBody {
        public static Object lambda11recur(Object lis) {
            ...
            frame6.elt = C0731lists.car.apply1(frame6.lis);
    ...
    public class frame6 extends ModuleBody {
        ...
        public Object lambda12() {
            return frame5.lambda11recur(C0731lists.cdr.apply1(this.lis));
        }

        /* access modifiers changed from: package-private */
        public Object lambda13(Object a, Object b, Object c, Object d, Object e) {
            return misc.values(C0731lists.cons(C0731lists.car.apply1(this.elt), a), C0731lists.cons(C0731lists.cadr.apply1(this.elt), b), C0731lists.cons(C0731lists.caddr.apply1(this.elt), c), C0731lists.cons(C0731lists.cadddr.apply1(this.elt), d), C0731lists.cons(C0731lists.car.apply1(C0731lists.cddddr.apply1(this.elt)), e));
        }
    ...
    public static Object append$Ex$V(Object[] argsArray) {
        ...
        while (C0731lists.isPair(makeList)) {
            Object first2 = C0731lists.car.apply1(makeList);
            Object rest = C0731lists.cdr.apply1(makeList);
            if (!C0731lists.isPair(first2)) {
                lList = first2;
                makeList = rest;
            } else {
                try {
                    Object tail$Mncons = lastPair(first2);
                    while (C0731lists.isPair(rest)) {
                        Object next = C0731lists.car.apply1(rest);
                        rest = C0731lists.cdr.apply1(rest);
                        try {
                            C0731lists.setCdr$Ex((Pair) tail$Mncons, next);
                            if (C0731lists.isPair(next)) {
                                try {
    ...
    public static Object appendReverse(Object rev$Mnhead, Object tail) {
        while (isNullList(rev$Mnhead) == Boolean.FALSE) {
            Object rev$Mnhead2 = C0731lists.cdr.apply1(rev$Mnhead);
            tail = C0731lists.cons(C0731lists.car.apply1(rev$Mnhead), tail);
    ...
    public static Object appendReverse$Ex(Object rev$Mnhead, Object tail) {
        while (isNullList(rev$Mnhead) == Boolean.FALSE) {
            Object next$Mnrev = C0731lists.cdr.apply1(rev$Mnhead);
            try {
                C0731lists.setCdr$Ex((Pair) rev$Mnhead, tail);
                tail = rev$Mnhead;
    ...
    public class frame55 extends ModuleBody {
        ...
        public Object lambda74recur(Object lists) {
            if (!C0731lists.isPair(lists)) {
                return LList.Empty;
            }
            Object lis = C0731lists.car.apply1(lists);
            if (srfi1.isNullList(lis) != Boolean.FALSE) {
                return this.abort.apply1(LList.Empty);
            }
            return C0731lists.cons(C0731lists.cdr.apply1(lis), lambda74recur(C0731lists.cdr.apply1(lists)));
        }
    }
    ...
    public class frame56 extends ModuleBody {
        ...
        public Object lambda75recur(Object lists) {
            return C0731lists.isPair(lists) ? C0731lists.cons(C0731lists.caar.apply1(lists), lambda75recur(C0731lists.cdr.apply1(lists))) : LList.list1(this.last$Mnelt);
        }
    }
    ...
    public class frame57 extends ModuleBody {
        ...
        public Object lambda76recur(Object lists) {
            ...
            frame58.lists = lists;
            if (C0731lists.isPair(frame58.lists)) {
    ...
    public class frame60 extends ModuleBody {
        ...
        public Object lambda82(Object cars, Object cdrs) {
            return misc.values(C0731lists.cons(this.f126a, cars), C0731lists.cons(this.f127d, cdrs));
        }
    ...
    public class frame63 extends ModuleBody {
        ...
        public Object lambda85recur(Object lists) {
            ...
            frame64.lists = lists;
            if (C0731lists.isPair(frame64.lists)) {
    ...
    public class frame66 extends ModuleBody {
        ...
        public Object lambda91(Object cars, Object cdrs) {
            return misc.values(C0731lists.cons(this.f128a, cars), C0731lists.cons(this.f129d, cdrs));
        }
    ...
    public class frame67 extends ModuleBody {
        public static Object lambda92recur(Object lists) {
            ...
            frame68.lists = lists;
            if (C0731lists.isPair(frame68.lists)) {
    ...
    public class frame70 extends ModuleBody {
        ...
        public Object lambda98(Object cars, Object cdrs) {
            return misc.values(C0731lists.cons(this.f130a, cars), C0731lists.cons(this.f131d, cdrs));
        }
    ...
    public static Object count$V(Procedure pred, Object list1, Object[] argsArray) {
        Object i;
        Object makeList = LList.makeList(argsArray, 0);
        if (C0731lists.isPair(makeList)) {
            i = Lit0;
            while (isNullList(list1) == Boolean.FALSE) {
                Object split = $PcCars$PlCdrs$SlPair(makeList);
                Object a$Mns = C0731lists.car.apply1(split);
                Object d$Mns = C0731lists.cdr.apply1(split);
                if (C0731lists.isNull(a$Mns)) {
                    break;
                }
                Object list12 = C0731lists.cdr.apply1(list1);
                if (Scheme.apply.apply3(pred, C0731lists.car.apply1(list1), a$Mns) != Boolean.FALSE) {
            ...
            while (isNullList(lis) == Boolean.FALSE) {
                Object lis2 = C0731lists.cdr.apply1(lis);
                if (pred.apply1(C0731lists.car.apply1(lis)) != Boolean.FALSE) {
                    i = AddOp.$Pl.apply2(i, Lit1);
                }
                lis = lis2;
            }
    ...
    public static Object unfoldRight(Procedure p, Procedure f, Procedure g, Object seed, Object obj) {
        while (p.apply1(seed) == Boolean.FALSE) {
            ...
            obj = C0731lists.cons(f.apply1(seed), obj);
            seed = seed2;
        }
        return obj;
    }
    ...
    public static Object unfold$V(Procedure p, Procedure f, Procedure g, Object seed, Object[] argsArray) {
        ...
        if (C0731lists.isPair(maybe$Mntail$Mngen)) {
            Object tail$Mngen = C0731lists.car.apply1(maybe$Mntail$Mngen);
            if (C0731lists.isPair(C0731lists.cdr.apply1(maybe$Mntail$Mngen))) {
        ...
        while (p.apply1(seed) == Boolean.FALSE) {
            ...
            lList = C0731lists.cons(f.apply1(seed), lList);
            seed = seed3;
        }
        try {
    ...
    public static Object fold$V(Procedure kons, Object knil, Object lis1, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        if (C0731lists.isPair(lists)) {
            return frame73.lambda14lp(C0731lists.cons(lis1, lists), knil);
        }
        Object lis = lis1;
        while (isNullList(lis) == Boolean.FALSE) {
            Object lis2 = C0731lists.cdr.apply1(lis);
            knil = frame73.kons.apply2(C0731lists.car.apply1(lis), knil);
            lis = lis2;
        }
        return knil;
    }
    ...
    public class frame8 extends ModuleBody {
        ...
        public Object lambda16(Object cars$Plans, Object cdrs) {
            if (C0731lists.isNull(cars$Plans)) {
                return this.ans;
            }
    ...
    public static Object foldRight$V(Procedure kons, Object knil, Object lis1, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        if (C0731lists.isPair(lists)) {
            return frame92.lambda17recur(C0731lists.cons(lis1, lists));
        }
    ...
    public class frame9 extends ModuleBody {
        ...
        public Object lambda18recur(Object lis) {
            ...
            return this.kons.apply2(C0731lists.car.apply1(lis), lambda18recur(C0731lists.cdr.apply1(lis)));
        }
    }
    ...
    public static Object pairFoldRight$V(Procedure f, Object zero, Object lis1, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        if (C0731lists.isPair(lists)) {
            return frame102.lambda19recur(C0731lists.cons(lis1, lists));
        }
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda19recur(Object lists) {
            ...
            return Scheme.apply.apply2(this.f111f, srfi1.append$Ex$V(new Object[]{lists, LList.list1(lambda19recur(cdrs))}));
        }

        public Object lambda20recur(Object lis) {
            return srfi1.isNullList(lis) != Boolean.FALSE ? this.zero : this.f111f.apply2(lis, lambda20recur(C0731lists.cdr.apply1(lis)));
        }
    }
    ...
    public static Object pairFold$V(Procedure f, Object zero, Object lis1, Object[] argsArray) {
        LList lists = LList.makeList(argsArray, 0);
        if (C0731lists.isPair(lists)) {
            Object cons = C0731lists.cons(lis1, lists);
            while (true) {
                Object tails = $PcCdrs(cons);
                if (C0731lists.isNull(tails)) {
                    break;
                }
            ...
            Object lis = lis1;
            while (isNullList(lis) == Boolean.FALSE) {
                Object tail = C0731lists.cdr.apply1(lis);
    ...
    public static Object reduce(Procedure f, Object ridentity, Object lis) {
        return isNullList(lis) != Boolean.FALSE ? ridentity : fold$V(f, C0731lists.car.apply1(lis), C0731lists.cdr.apply1(lis), new Object[0]);
    }

    public static Object reduceRight(Procedure f, Object ridentity, Object lis) {
        frame11 frame112 = new frame11();
        frame112.f112f = f;
        return isNullList(lis) != Boolean.FALSE ? ridentity : frame112.lambda21recur(C0731lists.car.apply1(lis), C0731lists.cdr.apply1(lis));
    }
    ...
    public class frame11 extends ModuleBody {
        ...
        public Object lambda21recur(Object head, Object lis) {
            if (C0731lists.isPair(lis)) {
                return this.f112f.apply2(head, lambda21recur(C0731lists.car.apply1(lis), C0731lists.cdr.apply1(lis)));
            }
            return head;
        }
    }
    ...
    public static Object map$Ex$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        if (C0731lists.isPair(makeList)) {
            ...
            while (isNullList(lis12) == Boolean.FALSE) {
                ...
                Object heads = C0731lists.car.apply1(split);
                Object tails = C0731lists.cdr.apply1(split);
                try {
                    C0731lists.setCar$Ex((Pair) lis12, Scheme.apply.apply3(frame122.f113f, C0731lists.car.apply1(lis12), heads));
                    lis12 = C0731lists.cdr.apply1(lis12);
                    makeList = tails;
                } catch (ClassCastException e) {
    ...
    public class frame12 extends ModuleBody {
        ...
        public void lambda22(Object pair) {
            try {
                C0731lists.setCar$Ex((Pair) pair, this.f113f.apply1(C0731lists.car.apply1(pair)));
            } catch (ClassCastException e) {
    ...
    public static Object filterMap$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        if (C0731lists.isPair(lists)) {
            return frame132.lambda23recur(C0731lists.cons(lis1, lists), LList.Empty);
        }
        LList lList = LList.Empty;
        Object lis = lis1;
        while (isNullList(lis) == Boolean.FALSE) {
            Object head = frame132.f114f.apply1(C0731lists.car.apply1(lis));
            Object tail = C0731lists.cdr.apply1(lis);
            if (head != Boolean.FALSE) {
                lList = C0731lists.cons(head, lList);
                lis = tail;
            } else {
                lis = tail;
            }
    ...
    public class frame14 extends ModuleBody {
        ...
        public Object lambda25(Object cars, Object cdrs) {
            if (srfi1.isNotPair(cars)) {
                Object obj = this.res;
                try {
                    return C0731lists.reverse$Ex((LList) obj);
                } catch (ClassCastException e) {
                    throw new WrongType(e, "reverse!", 1, obj);
                }
            } else {
                Object head = Scheme.apply.apply2(this.staticLink.f114f, cars);
                if (head != Boolean.FALSE) {
                    return this.staticLink.lambda23recur(cdrs, C0731lists.cons(head, this.res));
                }
    ...
    public static Object filter(Procedure pred, Object lis) {
        LList lList = LList.Empty;
        while (isNullList(lis) == Boolean.FALSE) {
            Object head = C0731lists.car.apply1(lis);
            Object tail = C0731lists.cdr.apply1(lis);
    ...
    public static Object filter$Ex(Procedure pred, Object lis) {
        ...
        while (true) {
            if (isNullList(ans) != Boolean.FALSE) {
                break;
            } else if (pred.apply1(C0731lists.car.apply1(ans)) == Boolean.FALSE) {
                ans = C0731lists.cdr.apply1(ans);
            } else {
                Object prev = C0731lists.cdr.apply1(ans);
                Object prev2 = ans;
                loop1:
                while (true) {
                    if (!C0731lists.isPair(prev)) {
                        break;
                    } else if (pred.apply1(C0731lists.car.apply1(prev)) != Boolean.FALSE) {
                        prev2 = prev;
                        prev = C0731lists.cdr.apply1(prev);
                    } else {
                        Object lis2 = C0731lists.cdr.apply1(prev);
                        while (C0731lists.isPair(lis2)) {
                            if (pred.apply1(C0731lists.car.apply1(lis2)) != Boolean.FALSE) {
                                try {
                                    C0731lists.setCdr$Ex((Pair) prev2, lis2);
                                    prev2 = lis2;
                                    prev = C0731lists.cdr.apply1(lis2);
                                } catch (ClassCastException e) {
                                    throw new WrongType(e, "set-cdr!", 1, prev2);
                                }
                            } else {
                                lis2 = C0731lists.cdr.apply1(lis2);
                            }
                        }
                        try {
                            C0731lists.setCdr$Ex((Pair) prev2, lis2);
    ...
    public static Object partition(Procedure pred, Object lis) {
        ...
        while (isNullList(lis) == Boolean.FALSE) {
            ...
            if (pred.apply1(head) != Boolean.FALSE) {
                ...
                out = C0731lists.cons(head, out);
                lis = tail;
            }
        }
        Object[] objArr = new Object[2];
        try {
            objArr[0] = C0731lists.reverse$Ex(lList);
            try {
                objArr[1] = C0731lists.reverse$Ex((LList) out);
    ...
    public static Object partition$Ex(Procedure pred, Object in) {
        Pair in$Mnhead = C0731lists.cons(Lit2, LList.Empty);
        Pair out$Mnhead = C0731lists.cons(Lit2, LList.Empty);
        Pair in2 = in$Mnhead;
        Pair out = out$Mnhead;
        while (!isNotPair(in)) {
            if (pred.apply1(C0731lists.car.apply1(in)) != Boolean.FALSE) {
                try {
                    C0731lists.setCdr$Ex(in2, in);
                    in2 = in;
                    in = C0731lists.cdr.apply1(in);
                } catch (ClassCastException e) {
                    throw new WrongType(e, "set-cdr!", 1, (Object) in2);
                }
            } else {
                try {
                    C0731lists.setCdr$Ex((Pair) out, in);
                    out = in;
                    in = C0731lists.cdr.apply1(in);
                } catch (ClassCastException e2) {
        ...
        try {
            C0731lists.setCdr$Ex(in2, LList.Empty);
            try {
                C0731lists.setCdr$Ex((Pair) out, LList.Empty);
                return misc.values(C0731lists.cdr.apply1(in$Mnhead), C0731lists.cdr.apply1(out$Mnhead));
            } catch (ClassCastException e3) {
    ...
    public class frame17 extends ModuleBody {
        ...
        public boolean lambda28(Object y) {
            return ((Scheme.applyToArgs.apply3(this.maybe$Mn$Eq, this.f115x, y) != Boolean.FALSE ? 1 : 0) + 1) & true;
        }
    ...
    public class frame18 extends ModuleBody {
        ...
        public boolean lambda29(Object y) {
            return ((Scheme.applyToArgs.apply3(this.maybe$Mn$Eq, this.f116x, y) != Boolean.FALSE ? 1 : 0) + 1) & true;
        }
    ...
    public class frame19 extends ModuleBody {
        ...
        public Object lambda30recur(Object lis) {
            ...
            Object x = C0731lists.car.apply1(lis);
            Object tail = C0731lists.cdr.apply1(lis);
            Object new$Mntail = lambda30recur(srfi1.delete(x, tail, this.maybe$Mn$Eq));
            return tail != new$Mntail ? C0731lists.cons(x, new$Mntail) : lis;
        }
    }
    ...
    public static Pair alistCons(Object key, Object datum, Object alist) {
        return C0731lists.cons(C0731lists.cons(key, datum), alist);
    }
    ...
    public static LList alistCopy(Object alist) {
        ...
        while (arg0 != LList.Empty) {
            try {
                ...
                obj = Pair.make(C0731lists.cons(C0731lists.car.apply1(elt), C0731lists.cdr.apply1(elt)), obj);
                arg0 = arg03;
            } catch (ClassCastException e) {
                throw new WrongType(e, "arg0", -2, arg0);
            }
    ...
    public class frame21 extends ModuleBody {
        ...
        public boolean lambda32(Object elt) {
            return ((Scheme.applyToArgs.apply3(this.maybe$Mn$Eq, this.key, C0731lists.car.apply1(elt)) != Boolean.FALSE ? 1 : 0) + 1) & true;
        }
    ...
    public static Object find(Object pred, Object list) {
        try {
            ...
            if (temp != Boolean.FALSE) {
                return C0731lists.car.apply1(temp);
            }
            return Boolean.FALSE;
        } catch (ClassCastException e) {
    ...
    public static Object findTail(Procedure pred, Object list) {
        while (true) {
            ...
            try {
                ...
                if (pred.apply1(C0731lists.car.apply1(list)) != Boolean.FALSE) {
                    return list;
                }
                list = C0731lists.cdr.apply1(list);
            } catch (ClassCastException e) {
                throw new WrongType(e, "x", -2, isNullList);
            }
        }
    ...
    public class frame23 extends ModuleBody {
        ...
        public Object lambda34recur(Object lis) {
            ...
            Object x = C0731lists.car.apply1(lis);
            return this.pred.apply1(x) != Boolean.FALSE ? C0731lists.cons(x, lambda34recur(C0731lists.cdr.apply1(lis))) : LList.Empty;
        }
    }
    ...
    public static Object takeWhile$Ex(Procedure pred, Object lis) {
        ...
        if (x == Boolean.FALSE ? pred.apply1(C0731lists.car.apply1(lis)) == Boolean.FALSE : x != Boolean.FALSE) {
            return LList.Empty;
        }
        Object prev = C0731lists.cdr.apply1(lis);
        Object prev2 = lis;
        while (C0731lists.isPair(prev)) {
            if (pred.apply1(C0731lists.car.apply1(prev)) != Boolean.FALSE) {
                prev2 = prev;
                prev = C0731lists.cdr.apply1(prev);
            } else {
                try {
                    C0731lists.setCdr$Ex((Pair) prev2, LList.Empty);
                    return lis;
                } catch (ClassCastException e) {
                    throw new WrongType(e, "set-cdr!", 1, prev2);
                }
    ...
    public static Object span(Procedure pred, Object lis) {
        ...
        try {
            objArr2[0] = C0731lists.reverse$Ex(lList);
            objArr2[1] = lis;
    ...
    /* renamed from: break  reason: not valid java name */
    public static Object m225break(Object pred, Object lis) {
    ...
    public static Object any$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        if (C0731lists.isPair(frame262.lists)) {
        ...
        try {
            ...
            Object head = C0731lists.car.apply1(frame262.lis1);
            for (Object apply1 = C0731lists.cdr.apply1(frame262.lis1); isNullList(apply1) == Boolean.FALSE; apply1 = C0731lists.cdr.apply1(apply1)) {
                Object x2 = frame262.pred.apply1(head);
                if (x2 != Boolean.FALSE) {
                    return x2;
                }
                head = C0731lists.car.apply1(apply1);
            }
    ...
    public class frame26 extends ModuleBody {
        ...
        public Object lambda37() {
            return srfi1.$PcCars$PlCdrs(C0731lists.cons(this.lis1, this.lists));
        }

        /* access modifiers changed from: package-private */
        public Object lambda38(Object heads, Object tails) {
            boolean x = C0731lists.isPair(heads);
            if (!x) {
                return x ? Boolean.TRUE : Boolean.FALSE;
            }
            while (true) {
                Object split = srfi1.$PcCars$PlCdrs$SlPair(tails);
                Object next$Mnheads = C0731lists.car.apply1(split);
                Object next$Mntails = C0731lists.cdr.apply1(split);
                if (!C0731lists.isPair(next$Mnheads)) {
    ...
    public static Object every$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        if (C0731lists.isPair(frame272.lists)) {
        ...
        Object head = C0731lists.car.apply1(frame272.lis1);
        for (Object apply1 = C0731lists.cdr.apply1(frame272.lis1); isNullList(apply1) == Boolean.FALSE; apply1 = C0731lists.cdr.apply1(apply1)) {
    ...
    public class frame27 extends ModuleBody {
        ...
        public Object lambda40(Object heads, Object tails) {
            ...
            boolean x = ((C0731lists.isPair(heads) ? 1 : 0) + true) & true;
            if (x) {
                return x ? Boolean.TRUE : Boolean.FALSE;
            }
    ...
    public static Object listIndex$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        if (C0731lists.isPair(lists)) {
            return frame302.lambda44lp(C0731lists.cons(lis1, lists), Lit0);
        }
        Object obj = Lit0;
        Object lis = lis1;
        while (true) {
            ...
            try {
                ...
                if (frame302.pred.apply1(C0731lists.car.apply1(lis)) != Boolean.FALSE) {
                    return obj;
                }
                lis = C0731lists.cdr.apply1(lis);
    ...
    public class frame31 extends ModuleBody {
        ...
        public Object lambda46(Object heads, Object tails) {
            ...
            return this.staticLink.lambda44lp(tails, AddOp.$Pl.apply2(this.f117n, srfi1.Lit1));
        }
    ...
    public class frame72 extends ModuleBody {
        ...
        public Object lambda101(Object x) {
            ...
            Object obj2 = this.$Eq;
            try {
                return C0731lists.member(x, obj, (Procedure) obj2);
            } catch (ClassCastException e) {
    ...
    public static Object lset$Ls$Eq$V(Procedure $Eq, Object[] argsArray) {
        ...
        Object x2;
        LList lists = LList.makeList(argsArray, 0);
        boolean x3 = ((C0731lists.isPair(lists) ? 1 : 0) + true) & true;
        if (x3) {
            return x3 ? Boolean.TRUE : Boolean.FALSE;
        }
        Object s1 = C0731lists.car.apply1(lists);
        Object apply1 = C0731lists.cdr.apply1(lists);
        while (true) {
            boolean x4 = ((C0731lists.isPair(apply1) ? 1 : 0) + true) & true;
            if (x4) {
                return x4 ? Boolean.TRUE : Boolean.FALSE;
            }
            Object s2 = C0731lists.car.apply1(apply1);
            apply1 = C0731lists.cdr.apply1(apply1);
            if (s2 == s1) {
                x = true;
            } else {
    ...
    public class frame32 extends ModuleBody {
        ...
        public Object lambda47(Object elt, Object ans) {
            return C0731lists.member(elt, ans, this.$Eq) != Boolean.FALSE ? ans : C0731lists.cons(elt, ans);
        }
    ...
    public class frame33 extends ModuleBody {
        ...
        public Object lambda48(Object lis, Object ans) {
            if (C0731lists.isNull(lis)) {
                return ans;
            }
            if (C0731lists.isNull(ans)) {
                return lis;
            }
        ...
        public Object lambda49(Object elt, Object ans) {
            ...
            frame34.elt = elt;
            return srfi1.any$V(frame34.lambda$Fn33, ans, new Object[0]) != Boolean.FALSE ? ans : C0731lists.cons(frame34.elt, ans);
        }
    ...
    public class frame35 extends ModuleBody {
        ...
        public Object lambda52(Object pair, Object ans) {
            ...
            frame36.elt = C0731lists.car.apply1(pair);
            if (srfi1.any$V(frame36.lambda$Fn36, ans, new Object[0]) != Boolean.FALSE) {
                return ans;
            }
            try {
                C0731lists.setCdr$Ex((Pair) pair, ans);
                return pair;
            } catch (ClassCastException e) {
    ...
    public static Object lsetIntersection$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        return !C0731lists.isNull(frame372.lists) ? filter(frame372.lambda$Fn37, lis1) : lis1;
    }
    ...
    public class frame38 extends ModuleBody {
        ...
        public Object lambda55(Object lis) {
            return C0731lists.member(this.f118x, lis, this.staticLink.$Eq);
        }
    ...
    public static Object lsetIntersection$Ex$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        return !C0731lists.isNull(frame392.lists) ? filter$Ex(frame392.lambda$Fn39, lis1) : lis1;
    }
    ...
    public class frame40 extends ModuleBody {
        ...
        public Object lambda57(Object lis) {
            return C0731lists.member(this.f119x, lis, this.staticLink.$Eq);
        }
    ...
    public static Object lsetDifference$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        frame412.$Eq = $Eq;
        frame412.lists = filter(C0731lists.pair$Qu, LList.makeList(argsArray, 0));
        if (C0731lists.isNull(frame412.lists)) {
            return lis1;
        }
        if (C0731lists.memq(lis1, frame412.lists) != Boolean.FALSE) {
            return LList.Empty;
        }
    ...
    public class frame42 extends ModuleBody {
        ...
        public boolean lambda59(Object lis) {
            return ((C0731lists.member(this.f120x, lis, this.staticLink.$Eq) != Boolean.FALSE ? 1 : 0) + 1) & true;
        }
    ...
    public static Object lsetDifference$Ex$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        frame432.$Eq = $Eq;
        frame432.lists = filter(C0731lists.pair$Qu, LList.makeList(argsArray, 0));
        if (C0731lists.isNull(frame432.lists)) {
            return lis1;
        }
        if (C0731lists.memq(lis1, frame432.lists) != Boolean.FALSE) {
            return LList.Empty;
        }
    ...
    public class frame44 extends ModuleBody {
        ...
        public boolean lambda61(Object lis) {
            return ((C0731lists.member(this.f121x, lis, this.staticLink.$Eq) != Boolean.FALSE ? 1 : 0) + 1) & true;
        }
    ...
    public class frame46 extends ModuleBody {
        ...
        public Object lambda63() {
            return srfi1.lsetDiff$PlIntersection$V(this.staticLink.$Eq, this.f122a, new Object[]{this.f123b});
        }
        ...
        public Object lambda64(Object a$Mnb, Object aIntB) {
            ...
            if (C0731lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$V(this.staticLink.$Eq, this.f123b, new Object[]{this.f122a});
            } else if (!C0731lists.isNull(frame47.a$Mnint$Mnb)) {
                return srfi1.fold$V(frame47.lambda$Fn48, a$Mnb, this.f123b, new Object[0]);
            } else {
                return append.append$V(new Object[]{this.f123b, this.f122a});
            }
        }
    ...
    public class frame47 extends ModuleBody {
        ...
        public Object lambda65(Object xb, Object ans) {
            return C0731lists.member(xb, this.a$Mnint$Mnb, this.staticLink.staticLink.$Eq) != Boolean.FALSE ? ans : C0731lists.cons(xb, ans);
        }
    ...
    public class frame49 extends ModuleBody {
        ...
        public Object lambda67() {
            return srfi1.lsetDiff$PlIntersection$Ex$V(this.staticLink.$Eq, this.f124a, new Object[]{this.f125b});
        }
        ...
        public Object lambda68(Object a$Mnb, Object aIntB) {
            ...
            if (C0731lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$Ex$V(this.staticLink.$Eq, this.f125b, new Object[]{this.f124a});
            } else if (!C0731lists.isNull(frame50.a$Mnint$Mnb)) {
                return srfi1.pairFold$V(frame50.lambda$Fn52, a$Mnb, this.f125b, new Object[0]);
            } else {
                return srfi1.append$Ex$V(new Object[]{this.f125b, this.f124a});
            }
        }
    ...
    public class frame50 extends ModuleBody {
        ...
        public Object lambda69(Object b$Mnpair, Object ans) {
            if (C0731lists.member(C0731lists.car.apply1(b$Mnpair), this.a$Mnint$Mnb, this.staticLink.staticLink.$Eq) != Boolean.FALSE) {
                return ans;
            }
            try {
                C0731lists.setCdr$Ex((Pair) b$Mnpair, ans);
                return b$Mnpair;
            } catch (ClassCastException e) {
    ...
    public static Object lsetDiff$PlIntersection$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        } else if (C0731lists.memq(lis1, frame512.lists) == Boolean.FALSE) {
    ...
    public class frame52 extends ModuleBody {
        ...
        public Object lambda71(Object lis) {
            return C0731lists.member(this.elt, lis, this.staticLink.$Eq);
        }
    ...
    public static Object lsetDiff$PlIntersection$Ex$V(Procedure $Eq, Object lis1, Object[] argsArray) {
        ...
        if (every$V(null$Mnlist$Qu, frame532.lists, new Object[0]) != Boolean.FALSE) {
            return misc.values(lis1, LList.Empty);
        } else if (C0731lists.memq(lis1, frame532.lists) == Boolean.FALSE) {
