...
public class enums extends ModuleBody {
    ...
    static LList mapNames(Symbol t$Mnname, LList e$Mnnames, int i) {
        if (C0731lists.isNull(e$Mnnames)) {
            return LList.Empty;
        }
        Object apply1 = C0731lists.car.apply1(e$Mnnames);
        try {
            Object makeFieldDesc = makeFieldDesc(t$Mnname, (Symbol) apply1, i);
            Object apply12 = C0731lists.cdr.apply1(e$Mnnames);
            try {
                return C0731lists.cons(makeFieldDesc, mapNames(t$Mnname, (LList) apply12, i + 1));
            } catch (ClassCastException e) {
