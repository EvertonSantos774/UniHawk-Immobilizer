...
public class ppfile extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda1(Object port) {
            ...
            Object outport = C0731lists.isNull(this.optarg) ? ports.current$Mnoutput$Mnport.apply0() : C0731lists.car.apply1(this.optarg);
                            ...
                            try {
                                if (characters.isChar$Eq(ppfile.Lit0, (Char) c)) {
                                    ...
                                    try {
                                        ...
                                        C0720pp.prettyPrint(Scheme.applyToArgs.apply2(this.staticLink.filter, o), export);
                                        c = readchar.peekChar.apply1(this.port);
