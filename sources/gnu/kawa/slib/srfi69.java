...
public class srfi69 extends ModuleBody {
                ...
                try {
                    ...
                    while (arg0 != LList.Empty) {
                        try {
                            ...
                            hashTableUpdate$Ex$SlDefault(hash$Mntable, C0731lists.car.apply1(elem), lambda$Fn1, C0731lists.cdr.apply1(elem));
                            arg0 = arg02.getCdr();
    ...
    public static hashtable.HashTable alist$To$HashTable(Object obj, Object obj2, Object obj3) {
        ...
        objArr[0] = Lit0;
        try {
            objArr[1] = Integer.valueOf(C0731lists.length((LList) obj) * 2);
    ...
    static Pair lambda2(Object key, Object val, Object acc) {
        return C0731lists.cons(key, acc);
    }
    ...
    static Pair lambda3(Object key, Object val, Object acc) {
        return C0731lists.cons(val, acc);
    }
