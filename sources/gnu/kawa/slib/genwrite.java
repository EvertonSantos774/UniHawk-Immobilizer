...
public class genwrite extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public static Object lambda1isReadMacro(Object l) {
            Object x;
            Object x2;
            Object head = C0731lists.car.apply1(l);
            Object tail = C0731lists.cdr.apply1(l);
            ...
            Object l2 = tail;
            boolean x4 = C0731lists.isPair(l2);
            return x4 ? C0731lists.isNull(C0731lists.cdr.apply1(l2)) ? Boolean.TRUE : Boolean.FALSE : x4 ? Boolean.TRUE : Boolean.FALSE;
        }

        public static Object lambda2readMacroBody(Object l) {
            return C0731lists.cadr.apply1(l);
        }

        public static Object lambda3readMacroPrefix(Object l) {
            Object head = C0731lists.car.apply1(l);
            C0731lists.cdr.apply1(l);
        ...
        public Object lambda5wr(Object obj, Object col) {
            ...
            Object l = C0731lists.cdr.apply1(obj);
            if (col != Boolean.FALSE) {
                col = lambda5wr(C0731lists.car.apply1(obj), lambda4out("(", col));
            }
            while (col != Boolean.FALSE) {
                if (C0731lists.isPair(l)) {
                    Object l2 = C0731lists.cdr.apply1(l);
                    col = lambda5wr(C0731lists.car.apply1(l), lambda4out(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, col));
                    l = l2;
                } else if (C0731lists.isNull(l)) {
                    return lambda4out(")", col);
                } else {
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda7pr(Object obj, Object col, Object extra, Object pp$Mnpair) {
            ...
            boolean x = C0731lists.isPair(obj);
        ...
        public Object lambda8ppExpr(Object expr, Object col, Object extra) {
            ...
            Object head = C0731lists.car.apply1(expr);
        ...
        public Object lambda9ppCall(Object expr, Object col, Object extra, Object pp$Mnitem) {
            Object col$St = this.staticLink.lambda5wr(C0731lists.car.apply1(expr), this.staticLink.lambda4out("(", col));
            if (col == Boolean.FALSE) {
                return col;
            }
            return lambda11ppDown(C0731lists.cdr.apply1(expr), col$St, AddOp.$Pl.apply2(col$St, genwrite.Lit17), extra, pp$Mnitem);
        }
        ...
        public Object lambda11ppDown(Object l, Object obj, Object col2, Object obj2, Object pp$Mnitem) {
            while (true) {
                ...
                if (!C0731lists.isPair(l)) {
                    return C0731lists.isNull(l) ? this.staticLink.lambda4out(")", obj) : this.staticLink.lambda4out(")", lambda7pr(l, lambda6indent(col2, this.staticLink.lambda4out(".", lambda6indent(col2, obj))), AddOp.$Pl.apply2(obj2, genwrite.Lit17), pp$Mnitem));
                }
                Object rest = C0731lists.cdr.apply1(l);
                l = rest;
                obj = lambda7pr(C0731lists.car.apply1(l), lambda6indent(col2, obj), C0731lists.isNull(rest) ? AddOp.$Pl.apply2(obj2, genwrite.Lit17) : genwrite.Lit1, pp$Mnitem);
            }
        }
        ...
        public Object lambda12ppGeneral(Object expr, Object col, Object extra, Object named$Qu, Object pp$Mn1, Object pp$Mn2, Object pp$Mn3) {
            ...
            Object extra3;
            Object head = C0731lists.car.apply1(expr);
            Object rest = C0731lists.cdr.apply1(expr);
            Object col$St = this.staticLink.lambda5wr(head, this.staticLink.lambda4out("(", col));
            if (named$Qu == Boolean.FALSE ? named$Qu != Boolean.FALSE : C0731lists.isPair(rest)) {
                Object name = C0731lists.car.apply1(rest);
            ...
            if (pp$Mn1 == Boolean.FALSE ? pp$Mn1 != Boolean.FALSE : C0731lists.isPair(rest)) {
                Object val1 = C0731lists.car.apply1(rest);
                rest = C0731lists.cdr.apply1(rest);
            ...
            if (pp$Mn2 == Boolean.FALSE ? pp$Mn2 != Boolean.FALSE : C0731lists.isPair(rest)) {
                Object val12 = C0731lists.car.apply1(rest);
                Object rest2 = C0731lists.cdr.apply1(rest);
                if (C0731lists.isNull(rest2)) {
        ...
        public Object lambda19pp$MnLET(Object expr, Object col, Object extra) {
            boolean named$Qu;
            Object rest = C0731lists.cdr.apply1(expr);
            boolean x = C0731lists.isPair(rest);
            if (x) {
                named$Qu = misc.isSymbol(C0731lists.car.apply1(rest));
            } else {
                named$Qu = x;
            }
    ...
    public class frame1 extends ModuleBody {
        ...
        public boolean lambda22(Object str) {
            this.result = C0731lists.cons(str, this.result);
            try {
    ...
    public static Object lambda23revStringAppend(Object l, Object i) {
        if (C0731lists.isPair(l)) {
            Object str = C0731lists.car.apply1(l);
            try {
                int len = strings.stringLength((CharSequence) str);
                Object result = lambda23revStringAppend(C0731lists.cdr.apply1(l), AddOp.$Pl.apply2(i, Integer.valueOf(len)));
                Object obj = Lit1;
                try {
