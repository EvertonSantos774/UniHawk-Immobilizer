...
public class srfi37 extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public static Object lambda1find(Object l, Object $Qu) {
            ...
            if (Scheme.applyToArgs.apply2($Qu, C0731lists.car.apply1(l)) != Boolean.FALSE) {
                return C0731lists.car.apply1(l);
            }
            return lambda1find(C0731lists.cdr.apply1(l), $Qu);
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:41:0x00c8, code lost:
            if (kawa.lib.C0731lists.isPair(r5.args) == false) goto L_0x00db;
         */
        ...
        public java.lang.Object lambda3scanShortOptions(java.lang.Object r10, java.lang.Object r11, java.lang.Object r12, java.lang.Object r13) {
            ...
            L_0x00b6:
                ...
                java.lang.Object r2 = r5.args
                boolean r2 = kawa.lib.C0731lists.isPair(r2)
        ...
        public Object lambda4scanOperands(Object operands, Object seeds) {
            ...
            frame2.seeds = seeds;
            if (C0731lists.isNull(frame2.operands)) {
        ...
        public java.lang.Object lambda5scanArgs(java.lang.Object r12, java.lang.Object r13) {
            /*
                ...
                r8.staticLink = r11
                r8.seeds = r13
                boolean r4 = kawa.lib.C0731lists.isNull(r12)
            ...
            L_0x0153:
                ...
                java.lang.Object r4 = r8.args
                boolean r4 = kawa.lib.C0731lists.isPair(r4)
    ...
    public class frame1 extends ModuleBody {
        ...
        public Object lambda11$V(Object[] argsArray) {
            return this.staticLink.lambda5scanArgs(C0731lists.cdr.apply1(this.args), LList.makeList(argsArray, 0));
        }
        ...
        public Object lambda10() {
            ...
            try {
                ...
                objArr[1] = this.option;
                objArr[2] = Char.make(this.name);
                objArr[3] = C0731lists.car.apply1(this.args);
                objArr[4] = this.seeds;
                return apply.applyN(objArr);
            } catch (ClassCastException e) {
    ...
    public class frame2 extends ModuleBody {
        ...
        public Object lambda14() {
            return Scheme.apply.apply3(this.staticLink.operand$Mnproc, C0731lists.car.apply1(this.operands), this.seeds);
        }

        /* access modifiers changed from: package-private */
        public Object lambda15$V(Object[] argsArray) {
            return this.staticLink.lambda4scanOperands(C0731lists.cdr.apply1(this.operands), LList.makeList(argsArray, 0));
        }
    }
    ...
    public class frame5 extends ModuleBody {
        ...
        public Object lambda20() {
            Object x = this.staticLink.staticLink.staticLink.lambda2findOption(this.staticLink.f220x);
            return x != Boolean.FALSE ? x : srfi37.option(LList.list1(this.staticLink.f220x), Boolean.TRUE, Boolean.FALSE, this.staticLink.staticLink.staticLink.unrecognized$Mnoption$Mnproc);
        }
    }
    ...
    public class frame6 extends ModuleBody {
        ...
        public Object lambda22() {
            Apply apply = Scheme.apply;
            Object[] objArr = new Object[5];
            Object obj = this.f222x;
            try {
                objArr[0] = srfi37.optionProcessor((option$Mntype) obj);
                objArr[1] = this.f222x;
                objArr[2] = this.staticLink.staticLink.f220x;
                objArr[3] = this.staticLink.f221x;
