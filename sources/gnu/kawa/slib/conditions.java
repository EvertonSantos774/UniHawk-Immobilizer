...
public class conditions extends ModuleBody {
    ...
    public static condition.Mntype makeConditionType(Symbol name, condition.Mntype supertype, Object fields) {
        if (!C0731lists.isNull(srfi1.lsetIntersection$V(Scheme.isEq, supertype.all$Mnfields, new Object[]{fields}))) {
    ...
    static Object conditionTypeFieldSupertype(condition.Mntype condition$Mntype, Object field) {
        while (condition$Mntype != Boolean.FALSE) {
            if (C0731lists.memq(field, condition$Mntype.fields) != Boolean.FALSE) {
    ...
    public static condition makeCondition$V(condition.Mntype type, Object[] argsArray) {
        ...
        return new condition(LList.list1(C0731lists.cons(type, alist)));
    }
    ...
    public static Object lambda1label(Object plist) {
        if (C0731lists.isNull(plist)) {
            return LList.Empty;
        }
        return C0731lists.cons(C0731lists.cons(C0731lists.car.apply1(plist), C0731lists.cadr.apply1(plist)), lambda1label(C0731lists.cddr.apply1(plist)));
    }

    public static boolean isConditionHasType(Object condition2, condition.Mntype type) {
        Object types = conditionTypes(condition2);
        while (true) {
            Object apply1 = C0731lists.car.apply1(types);
            try {
                boolean x = isConditionSubtype((condition.Mntype) apply1, type);
                if (x) {
                    return x;
                }
                types = C0731lists.cdr.apply1(types);
            } catch (ClassCastException e) {
    ...
    static Object typeFieldAlistRef(Object type$Mnfield$Mnalist, Object field) {
        while (!C0731lists.isNull(type$Mnfield$Mnalist)) {
            Object temp = C0731lists.assq(field, C0731lists.cdr.apply1(C0731lists.car.apply1(type$Mnfield$Mnalist)));
            if (temp != Boolean.FALSE) {
                return C0731lists.cdr.apply1(temp);
            }
            type$Mnfield$Mnalist = C0731lists.cdr.apply1(type$Mnfield$Mnalist);
        }
    ...
    public static condition makeCompoundCondition$V(Object condition$Mn1, Object[] argsArray) {
        ...
        Object cons = C0731lists.cons(condition$Mn1, conditions);
        Object obj = LList.Empty;
    ...
    public static condition extractCondition(condition condition2, condition.Mntype type) {
        ...
        while (arg0 != LList.Empty) {
            try {
                Pair arg02 = (Pair) arg0;
                Object arg03 = arg02.getCdr();
                obj = Pair.make(C0731lists.assq(arg02.getCar(), C0731lists.cdr.apply1(entry)), obj);
                arg0 = arg03;
            } catch (ClassCastException e) {
                throw new WrongType(e, "arg0", -2, arg0);
            }
        }
        return new condition(LList.list1(C0731lists.cons(mntype, LList.reverseInPlace(obj))));
    }
    ...
    public class frame extends ModuleBody {
        ...
        public boolean lambda2(Object entry) {
            Object apply1 = C0731lists.car.apply1(entry);
            try {
    ...
    public static condition typeFieldAlist$To$Condition(Object type$Mnfield$Mnalist) {
        ...
        while (arg0 != LList.Empty) {
            try {
                ...
                Object apply1 = C0731lists.car.apply1(entry);
                Object arg04 = ((condition.Mntype) C0731lists.car.apply1(entry)).all$Mnfields;
                Object obj = LList.Empty;
                while (arg04 != LList.Empty) {
                    try {
                        ...
                        Object x = C0731lists.assq(field, C0731lists.cdr.apply1(entry));
                        if (x == Boolean.FALSE) {
                            x = C0731lists.cons(field, typeFieldAlistRef(type$Mnfield$Mnalist, field));
                        }
                        obj = Pair.make(x, obj);
                        arg04 = arg06;
                    } catch (ClassCastException e) {
                ...
                pair = Pair.make(C0731lists.cons(apply1, LList.reverseInPlace(obj)), pair);
                arg0 = arg03;
            } catch (ClassCastException e2) {
    ...
    static Object checkConditionTypeFieldAlist(Object the$Mntype$Mnfield$Mnalist) {
        ...
        while (!C0731lists.isNull(type$Mnfield$Mnalist)) {
            Object entry = C0731lists.car.apply1(type$Mnfield$Mnalist);
            Object apply1 = C0731lists.car.apply1(entry);
            try {
                condition.Mntype type = (condition.Mntype) apply1;
                Object field$Mnalist = C0731lists.cdr.apply1(entry);
                Object obj = LList.Empty;
                ...
                while (arg04 != LList.Empty) {
                    try {
                        ...
                        while (true) {
                            Object apply12 = C0731lists.car.apply1(C0731lists.car.apply1(alist));
                            try {
                                try {
                                    ...
                                    alist = C0731lists.cdr.apply1(alist);
                                } catch (ClassCastException e2) {
