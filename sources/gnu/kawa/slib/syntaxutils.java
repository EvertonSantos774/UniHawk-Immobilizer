...
public class syntaxutils extends ModuleBody {
        ...
        if (exp instanceof LetExp) {
            ...
            try {
                ...
                for (Declaration decl = exp3.firstDecl(); decl != null; decl = decl.nextDecl()) {
                    closureEnv.pack = C0731lists.cons(decl.getSymbol(), closureEnv.pack);
                }
                objArr2[0] = C0731lists.reverse$Ex(closureEnv.pack);
    ...
    static java.lang.Object unrewrite$St(gnu.expr.Expression[] r7) {
        ...
        L_0x0010:
            ...
            gnu.lists.Pair r4 = kawa.lib.C0731lists.cons(r3, r4)
            r0.pack = r4
        ...
        L_0x0039:
            gnu.lists.LList r4 = r0.pack
            gnu.lists.LList r4 = kawa.lib.C0731lists.reverse$Ex(r4)
            return r4
        */
