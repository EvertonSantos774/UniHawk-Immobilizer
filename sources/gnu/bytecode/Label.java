...
public class Label {
    ...
    public void setTypes(CodeAttr code) {
        ...
        if (this.stackTypes == null || code.f46SP == this.stackTypes.length) {
            setTypes(code.local_types, code.local_types == null ? 0 : code.local_types.length, code.stack_types, code.f46SP);
            return;
        }
