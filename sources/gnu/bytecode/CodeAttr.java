...
public class CodeAttr extends Attribute implements AttrContainer {
    ...
    public final void fixupAdd(int kind, Label label) {
        fixupAdd(kind, this.f45PC, label);
    }
    ...
    public final void reserve(int bytes) {
        ...
        } else if (this.f45PC + bytes > this.code.length) {
            byte[] new_code = new byte[((this.code.length * 2) + bytes)];
            System.arraycopy(this.code, 0, new_code, 0, this.f45PC);
            this.code = new_code;
        }
    }
    ...
    public final void pushType(Type type) {
        ...
        } else if (this.f46SP + 1 >= this.stack_types.length) {
            Type[] new_array = new Type[(this.stack_types.length * 2)];
            System.arraycopy(this.stack_types, 0, new_array, 0, this.f46SP);
        ...
        this.f46SP = i2 + 1;
        typeArr2[i2] = type;
        if (this.f46SP > this.max_stack) {
            this.max_stack = this.f46SP;
        }
    }
    ...
    public final Type topType() {
        return this.stack_types[this.f46SP - 1];
    }
    ...
    public final void emitIfCompare1(int opcode) {
        ...
        new_if.start_stack_size = this.f46SP;
    }
    ...
    public final void emitThen() {
        this.if_stack.start_stack_size = this.f46SP;
    }
    ...
    public final void emitElse() {
        ...
        if (reachableHere()) {
            ...
            int growth = this.f46SP - this.if_stack.start_stack_size;
        ...
        while (this.f46SP > this.if_stack.start_stack_size) {
            popType();
        }
        this.f46SP = this.if_stack.start_stack_size;
        if (else_label != null) {
    ...
    public final void emitFi() {
        ...
        if (!this.if_stack.doing_else) {
            if (reachableHere() && this.f46SP != this.if_stack.start_stack_size) {
                throw new Error("at PC " + this.f45PC + " then clause grows stack with no else clause");
            }
            ...
            if (!reachableHere()) {
                ...
                this.f46SP = then_clause_stack_size;
            } else if (this.f46SP != then_clause_stack_size) {
                throw new Error("at PC " + this.f45PC + ": SP at end of 'then' was " + then_clause_stack_size + " while SP at end of 'else' was " + this.f46SP);
            }
    ...
    public void emitWithCleanupCatch(Variable catchVar) {
        ...
        emitTryEnd();
        if (this.f46SP > 0) {
            savedTypes = new Type[this.f46SP];
            System.arraycopy(this.stack_types, 0, savedTypes, 0, this.f46SP);
            this.f46SP = 0;
        } else {
            savedTypes = null;
        }
    ...
    public void emitWithCleanupDone() {
        ...
        emitTryCatchEnd();
        if (savedTypes != null) {
            this.f46SP = savedTypes.length;
            if (this.f46SP >= this.stack_types.length) {
                this.stack_types = savedTypes;
            } else {
                System.arraycopy(savedTypes, 0, this.stack_types, 0, this.f46SP);
            }
        } else {
            this.f46SP = 0;
        }
    ...
    public void emitTryStart(boolean has_finally, Type result_type) {
        ...
        if (result_type != null || this.f46SP > 0) {
            pushScope();
        }
        if (this.f46SP > 0) {
            savedStack = new Variable[this.f46SP];
            int i = 0;
            while (this.f46SP > 0) {
    ...
    public void write(DataOutputStream dstr) throws IOException {
        ...
        dstr.writeInt(this.f45PC);
        dstr.write(this.code, 0, this.f45PC);
