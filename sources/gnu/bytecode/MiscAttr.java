...
public class MiscAttr extends Attribute {
    ...
    /* renamed from: u1 */
    public int mo9393u1(int offset2) {
        return this.data[offset2] & 255;
    }

    /* access modifiers changed from: protected */
    /* renamed from: u2 */
    public int mo9395u2(int offset2) {
        return ((this.data[offset2] & 255) << 8) + (this.data[offset2 + 1] & 255);
    }
